  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        <Text>
          <Tspan style={{ color: "green" }}>Tspan part</Tspan> and normal part. <FaRupeeSign /> 1000 😀💩👻🙈❤️💕   🚩🚩 🕉️
        </Text>

        <View style={styles.section}>
          <Text>
            Visit{" "}
            <Link src="https://vais.co.in" style={styles.link}>
              Vais
            </Link>
          </Text>
        </View>
...
export default PostPdfComponent;
