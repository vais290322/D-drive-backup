  ...
  const downloadRoutine = async (e) => {
    ...
    try {
      const response = await axios.get(
        `http://192.168.0.141:8084/api/v1/routine/teacher/pdf?teacherName=${userDetails?.teachersName}`,
        {
          responseType: "blob",
        }
      );
      ...
      toast.error(error.response?.data?.message || "no routine found for you enjoy your day");
    }
  };
      ...
      <div>
        ...
        <div className="flex  gap-[10px] mx-14 mt-4 ">
          <div className="flex gap-[10px] flex-col">
            ...
            <div className="flex gap-[10px] ">
              <div
                className={` w-[565px] h-[548px] border shadow-xl rounded-xl ${
                  theme === "light"
                    ? "bg-[#212121] text-white border-gray-800 "
                    : "bg-white border-slate-200"
                }`}
