  ...
  const fetchTeacherData = async () => {
    try {
      ...
      const response = await axios.get(
        `${teacherEdpLibraryanUrlApi.addTeacher.url}`
      );
            ...
            <TableBody>
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  >
                    {item.villagePost}, {item.city}, {item.district},{" "}
                    {item.policeStation}, {item.state}, {item.pincode},{" "}
                    {item.country}
                  </TableCell>
                  <TableCell
                    className={`px-4 py-2 border text-left ${
                  ...
                  >
                    <div className="flex justify-end items-center gap-2">
                      ...
                      <DeleteComponent
                        ...
                        deletePath={`${teacherEdpLibraryanUrlApi.addTeacher.url}/${item.id}`} // API endpoint for deletion
                        onDelete={() => {
