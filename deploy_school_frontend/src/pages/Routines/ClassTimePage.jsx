  ...
  const updateClassTimeData = async (e, id) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${routineUrlApi.getClassTime.url}/${id}`,
        editInput,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      <div className={` ${theme === "light" ? "bg-[#212121]" : ""} `}>
        ...
        >
          ...
          <Table className="table-auto w-full border-collapse border border-slate-200">
            ...
            >
              <TableRow>
                {["S.No", "Periods", "Start Time", "End Time", "Action"].map(
                  (header, index) => (
                    <TableHead
                      key={index}
                ...
                >
                  ...
                  >
                    <div className="flex justify-end items-center gap-2">
                      ...
                      deletePath={`${routineUrlApi.getClassTime.url}/${item.id}`} // API endpoint for deletion
                      onDelete={() => {
