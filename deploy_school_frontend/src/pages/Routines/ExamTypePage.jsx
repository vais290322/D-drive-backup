...
const ExamTypePage = () => {
  ...
  const updateExamTypeData = async (e, id) => {
      ...
      try {
        ...
        const response = await axios.put(
          `${routineUrlApi.getExamType.url}/${id}`,
          editInput,
          {
            headers: {
  ...
  const addNewExamType = async (e) => {
    ...
    try {
      setPostApiLoading(true);
      const response = await axios.post(`${routineUrlApi.getExamType.url}`, input, {
        headers: {
          "Content-Type": "application/json",
        },
                ...
                >
                  <div className="flex justify-end items-center gap-2">
                    ...
                    <DeleteComponent
                      ...
                      deletePath={`${routineUrlApi.getExamType.url}/${item.id}`} // API endpoint for deletion
                      onDelete={() => {
