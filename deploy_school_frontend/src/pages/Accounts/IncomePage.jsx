...
const IncomePage = () => {
  ...
  // table data
  const data = [
    { id: 1, className: "Student fee", monthlyFees: "12-12-2024", quarterFees: " 5400", halfyearFees: "online" , amount: "nothing" },
  ...
  const formData = [
    ...
    { name: "incomeSource", label: "Income Source", type: "text", placeholder: "Enter income source", required: true },
    { name: "date", label: "Date of Income", type: "date", placeholder: "Enter date", required: true },
    { name: "description", label: "Description of Income", type: "text", placeholder: "Enter description", required: true },
  ]
      ...
      >
        ...
        <div
          ...
          <div className="sm:flex hidden items-center text-[1.25rem]">
            <AddNewComponents onChangeFunctin={changeEventHandler} onSubmitFunction={addNewExamType} dialogHeader={dialogHeader} formData={formData} inputValue={input} postApiLoading={postApiLoading} customContent={paymentMethodDropdown}/>
          </div>
        </div>
              ...
              >
                ...
                >
                  <div className="flex justify-end items-center gap-2">
                    {/* for edit data */}
                    <EditDataComponent formData={formData} postApiLoading={postApiLoading} onChangeFunctin={changeEventHandler} inputValue={input} onSubmitFunction={addNewExamType} customContent={paymentMethodDropdown} />
