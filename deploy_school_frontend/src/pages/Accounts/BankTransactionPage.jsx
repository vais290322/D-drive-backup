...
const BankTransactionPage = () => {
  ...
  // table data
  const data = [
    { id: 1, className: "Deposit", monthlyFees: "12-12-2024", quarterFees: " 5400", halfyearFees: "95000371200026" , amount: "nothing" },];
  ...
  const formData = [
    ...
    { name: "amount", label: "Total Amount", type: "text", placeholder: "Enter amount", required: true },
    { name: "date", label: "Date of Transaction", type: "date", placeholder: "Enter date", required: true },
    { name: "description", label: "Description of Transaction", type: "text", placeholder: "Enter description", required: true },
  ]
      ...
      >
        ...
        <div
          ...
          <div className="sm:flex hidden items-center text-[1.25rem]">
            <AddNewComponents onChangeFunctin={changeEventHandler} onSubmitFunction={addNewExamType} dialogHeader={dialogHeader} formData={formData} inputValue={input} postApiLoading={postApiLoading} customContent={transactionTypeDropdown}/>
          </div>
        </div>
              ...
              >
                ...
                >
                  <div className="flex justify-end items-center gap-2">
                    {/* for edit data */}
                    <EditDataComponent formData={formData} postApiLoading={postApiLoading} onChangeFunctin={changeEventHandler} inputValue={input} onSubmitFunction={addNewExamType} customContent={transactionTypeDropdown} />
