...
const persistConfig = {
  ...
  whitelist: ["class", "section", "subject", "subjectAssign", "classRoom","classTime", "classRoutine","examType","bookCategory","allBooks","examRoutine", "settings","studentInfo","teacherInfo","attendance","result","auth","institute"], // List the reducers you want to persist
};
