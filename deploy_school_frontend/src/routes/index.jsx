...
import PasswordResetForSignupPage from "@/pages/PasswordResetForSignupPage";
import CreateNewPasswordForSignupPage from "@/pages/CreateNewPasswordForSignupPage";
...
const router = createBrowserRouter([
  ...
  {
    path: "/reset-password",
    element:<PasswordResetForSignupPage/>
  },
  {
    path: "/create-new-password",
    element:<CreateNewPasswordForSignupPage/>
  },
