  ...
  const applyFilters = () => {
    ...
    if (filterType !== "all") {
      result = result.filter((item) => {
        ...
        return filterType === "income" ? type === "income" : type === "expense";
      });
    }
  ...
  const downloadPDFInView = () => {
    ...
    data.transactions.forEach((transaction, index) => {
      ...
      transactionRows.push([
        ...
        transaction.type==="income" ? "Credit" : "Debit" || "N/A",
...
Generated on: ${new Date().toLocaleString()}
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      doc.text("Snigdha All Ledger Report", 105, 18, { align: "center" });
      doc.setFontSize(10);
      ...
      const fileName = `snigdha_ledger_report_${
