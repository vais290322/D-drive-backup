...
const SnigdhaAllSellListPage = () => {
  ...
  const filteredData = data.filter((item) => {
    const matchesSearch =
      ...
      item?.contactPersonNumber?.toLowerCase()?.includes(searchTerm);
  ...
  return (
    ...
    <div className="mb-6 bg-white p-4">
     <h1 className="text-2xl font-semibold text-gray-800">All transfer items lists from Snigdha to mns </h1>
     <p className="text-gray-600">Manage and review all transfer lists here.</p>
     ...
     <div className="mt-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-lg shadow-lg">
       ...
       <div className="mt-2 text-sm opacity-80">
         <span>Total from {data.length} transfer lists </span>
       </div>
     </div>
   </div>
...
export default SnigdhaAllSellListPage