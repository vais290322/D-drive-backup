...
const exportToPDF = () => {
  ...
  doc.text(`Snigdha's Bank Statement - ${selectedBank?.bankName || 'Unknown Bank'}`, 14, 22);
  ...
  // Save
  doc.save(
    `bank_statement_snigdha_${selectedBank?.bankName || 'unknown'}_${format(new Date(), 'yyyyMMdd')}.pdf`
  );
};
...
const exportToExcel = () => {
  ...
  XLSX.writeFile(
    wb,
    `bank_statement_snigdha_${selectedBank?.bankName || 'unknown'}_${format(new Date(), 'yyyyMMdd')}.xlsx`
  );
};
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-800">Snigdha's Bank Statement</h1>
