...
const ServicePayment = () => {
  ...
  const handleSaveEdit = async () => {
    ...
    const grandTotal = parseFloat(selectedInvoice?.total?.grandTotal) || 0;
    ...
    try {
      const updateData = {
        ...serviceDetails,
        totalAmount: selectedInvoice?.total?.grandTotal || "",
        invoiceType: "Service",
        paymentDetails: [
          {
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  {isEditMode ? (
                    <div className="space-y-3">
                      ...
                      {/* {(serviceDetails.paymentDetails[0].paymentMode === "Card" || 
                        serviceDetails.paymentDetails[0].paymentMode === "UPI" || 
                        serviceDetails.paymentDetails[0].paymentMode === "NetBanking" || 
                        serviceDetails.paymentDetails[0].paymentMode === "BankTransfer") && ( */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Transaction ID
                        </label>
                      ...
                      {/* {(serviceDetails.paymentDetails[0].paymentMode === "Card" || 
                        serviceDetails.paymentDetails[0].paymentMode === "NetBanking" || 
                        serviceDetails.paymentDetails[0].paymentMode === "BankTransfer" ||
                        serviceDetails.paymentDetails[0].paymentMode === "Cheque") && ( */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Bank Account
                        </label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <input
                              type="text"
                              name="chequeNumber"
                              value={serviceDetails.paymentDetails[0].chequeNumber || ""}
                              onChange={(e) =>
                                setserviceDetails({
                                  ...serviceDetails,
                                  paymentDetails: [
                          ...
                          <div>
                            ...
                            <input
                              type="date"
                              name="chequeDate"
                              value={serviceDetails.paymentDetails[0].chequeDate || ""}
                              onChange={(e) =>
                                setserviceDetails({
                                  ...serviceDetails,
                                  paymentDetails: [
