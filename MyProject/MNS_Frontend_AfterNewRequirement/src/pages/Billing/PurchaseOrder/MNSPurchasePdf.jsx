...
const MNSPurchasePdf = ({ invoiceData }) => (
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.title}>Purchase Order for MNS</Text>
...
export default MNSPurchasePdf;

export const PDFDownloadButton = ({ invoice }) => {
  return (
    <PDFDownloadLink 
      document={<MNSPurchasePdf invoiceData={invoice} />} 
