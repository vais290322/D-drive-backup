...
const SnigdhaImprestFundPage = () => {
  ...
  const fetchImprestFund = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${backendDomainS}/api/v1/imprest-fund/all`);
  ...
  const fetchImprestFundHistory = async (id) => {
    try {
      const response = await axios.get(`${backendDomainS}/api/v1/imprest-fund/history/${id}`);
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      await axios.post(`${backendDomainS}/api/v1/imprest-fund/create`, createFormData);
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      await axios.put(`${backendDomainS}/api/v1/imprest-fund/update/${imprestFund._id}`, updateFormData);
  ...
  const handleDeductSubmit = async (e) => {
    ...
    try {
      await axios.put(`${backendDomainS}/api/v1/imprest-fund/deduct/${imprestFund._id}`, deductFormData);
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`${backendDomainS}/api/v1/imprest-fund/delete/${imprestFund._id}`);
...
export default SnigdhaImprestFundPage;
