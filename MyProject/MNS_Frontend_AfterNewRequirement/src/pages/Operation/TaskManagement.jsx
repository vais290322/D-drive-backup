    ...
    <div className="p-4">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 z-50">
          <div className="bg-white rounded-lg shadow-lg w-full sm:w-11/12 md:w-4/5 lg:w-3/4 xl:w-1/2 max-w-2xl relative max-h-[90vh] overflow-y-auto">
            <button
            ...
            <div className="w-full p-4 sm:p-6">
              <h2 className="text-xl sm:text-2xl font-semibold text-center text-gray-800 mb-4 sm:mb-6 mt-2">
                Send Task
              </h2>
              <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                <div className="relative">
                  ...
                  {filteredEmails.length > 0 && (
                    <ul className="absolute z-20 w-full border rounded-lg bg-white shadow-md max-h-40 overflow-auto">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[100px]"
                  required
                />
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-gray-700 block mb-1 text-sm">Task Start Date</label>
                    <input
                      type="date"
                      name="taskStartDate"
                  ...
                  <div>
                    <label className="text-gray-700 block mb-1 text-sm">Task End Date</label>
                    <input
                      type="date"
                      name="taskEndDate"
                ...
                <div>
                  <label className="text-gray-700 block mb-1 text-sm">Task Prioritization</label>
                  <select
...
{isEditModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 z-50">
          <div className="bg-white rounded-lg shadow-lg w-full sm:w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 max-w-2xl relative max-h-[90vh] overflow-y-auto">
            <button
            ...
            <div className="w-full p-4 sm:p-6">
              ...
              <form className="flex flex-col space-y-4">
                ...
                <div>
                  <label className="text-gray-700 block mb-1 text-sm">
                    Task Prioritization: {selectedClient?.taskPrioritization || ""}
                  </label>
                  <select
                    name="taskPrioritization"
...
{selectedOrder && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-90 overflow-auto p-4 z-50">
          <div className="bg-white rounded-lg shadow-lg w-full sm:w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 max-w-2xl relative max-h-[60vh] overflow-y-auto">
            <button
            ...
            <div className="p-4 sm:p-6">
              <h2 className="text-lg sm:text-xl font-semibold mb-4 border-b pb-2">Full Details</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm sm:text-base">
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Employee Name:</strong><br />
                    <span className="ml-2">{selectedOrder.employeeName}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Employee Code:</strong><br />
                    <span className="ml-2">{selectedOrder.employeeCode}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Email:</strong><br />
                    <span className="ml-2 break-words">{selectedOrder.email}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Assign Date:</strong><br />
                    <span className="ml-2">{selectedOrder.assignDate}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Completed Date:</strong><br />
                    <span className="ml-2">{selectedOrder.completedDate || "Not completed"}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Status:</strong><br />
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${
                      selectedOrder.taskStatus === "Completed" 
                ...
                <div className="bg-gray-50 p-2 rounded md:col-span-2">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Name:</strong><br />
                    <span className="ml-2">{selectedOrder.taskName}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded md:col-span-2">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Description:</strong><br />
                    <span className="ml-2 block mt-1 whitespace-pre-wrap">{selectedOrder.taskDescription}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Start Date:</strong><br />
                    <span className="ml-2">{selectedOrder.taskStartDate}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Ending Date:</strong><br />
                    <span className="ml-2">{selectedOrder.taskEndDate}</span>
                  </p>
                </div>
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Task Prioritization:</strong><br />
                    <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${
                      selectedOrder.taskPrioritization === "High" 
                ...
                <div className="bg-gray-50 p-2 rounded">
                  <p className="mb-2">
                    <strong className="text-gray-700">Update Date:</strong><br />
                    <span className="ml-2">{selectedOrder?.updateDate || "Not updated"}</span>
                  </p>
                </div>
              </div>
            </div>
