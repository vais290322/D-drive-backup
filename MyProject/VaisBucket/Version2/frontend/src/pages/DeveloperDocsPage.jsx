...
const DeveloperDocsPage = () => {
    ...
    const codeExamples = {
        curl: {
            title: "cURL (Upload)",
            code: `curl -X POST https://apibucket.vais.co.in/api/v1/files/upload \\
  ...
  -F "folderId=695ce180d810b1e51cc9" # Optional folder ID`,
        ...
        deleteCurl: {
            title: "cURL (Delete)",
            code: `curl -X DELETE https://apibucket.vais.co.in/api/v1/files/695ce180d810b1e51cc91237 \\
  -H "X-API-Key: YOUR_API_KEY"`,
        },
        javascript: {
...
const response = await axios.post('https://apibucket.vais.co.in/api/v1/files/upload', formData, {
  headers: {
...
url = "https://apibucket.vais.co.in/api/v1/files/upload"
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://apibucket.vais.co.in/api/v1/files/upload',
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://apibucket.vais.co.in/api/v1/files/upload");
