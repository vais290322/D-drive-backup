...
const LayoutComponent = () => {
  ...
  const hasAccess = (section) => {
    ...
    switch (section) {
      ...
      case "MNS Billing":
        return userRole === "billing" || userRole === "admin";
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <Link to="/" className="py-2 hover:text-gray-300">
            <div className="px-4 py-2 hover:bg-gray-700 cursor-pointer flex items-center">
              ...
              subSections: [
                {
                  ...
                  links: [
                    ...
                    { to: "/product-payment-invoice", label: "--Add Product Payment Invoice" },
                    { to: "/view-product-payment-invoice", label: "-- Manage Ladger Report" },
                    { to: "/view-proforma-invoice", label: "-- View Perfoma Invoice" },
                    { to: "/service-invoice-reports", label: "-- View Service Invoice " },
                  ],
                },
                // {
                //   name: "Tax",
                //   links: [
                //     { to: "/add-tax", label: "-- Add Tax" },
                //     // { to: "/view-invoice", label: "-- View Invoice" },
                //   ],
                // },
                // {
                //   name: "Coupons",
                //   links: [
                //     { to: "/add-coupon", label: "-- Add Coupons" },
                //     // { to: "/view-invoice", label: "-- View Invoice" },
                //   ],
                // },
                {
                ...
                },
                {
                  ...
                  links: [
                    ...
                    { to: "/received-po", label: "-- All transfer report to snigdha" },
                  ],
                },
                // {
                //   name: "Selling",
                ...
                // },
                {
                  name: "UNITS",
                  links: [
                    { to: "/set-units", label: "-- Set Units" },
                    // { to: "/received-po", label: "-- Received PO" },
                  ],
                },
              ...
              subSections: [
                {
                  ...
                  links: [
                    ...
                    { to: "/snigdha-product-payment-invoice", label: "--Add Payment For Invoice" },
                    { to: "/snigdha-ladger-report", label: "-- Manage Ladger Report" },
                  ],
                },
                {
                  name: "Inventory",
                  links: [
                    ...
                    { to: "/snigdha-inventory-management", label: "-- Inventory Management" },
                ...
                },
                {
                  ...
                  links: [
                    ...
                    { to: "/snigdha-inventory-report", label: "-- Inventory Report" },
                    { to: "/snigdha-sell-list", label: "-- All transfer report to mns " },
                  ],
                },
                // {
                //   name: "Selling",
                ...
                { 
                  name: "UNITS",
                  links: [
                    { to: "/snigdha-set-units", label: "-- Set Units" },
                  ],
                },
              ],
            },
          ].map(({ name, icon, links, subSections }) => (
            hasAccess(name) &&
            <div key={name}>
              <div
              ...
              {openSections[name] && !isSidebarCollapsed && (
                <div className="ml-6">
                  ...
                  {subSections &&
                    subSections.map(({ name: subName, links: subLinks }) => (
                      <div key={subName}>
                        <div
          ...
          <div>
            ...
            >
              ...
              {!isSidebarCollapsed &&
                (openSections.Operation ? <FaChevronUp /> : <FaChevronDown />)}
            </div>
            {openSections.Operation && !isSidebarCollapsed && (
              <div className="ml-6">
                ...
                <Link to="/task-management" className="py-2 hover:text-gray-300">
                  <div className="py-2 hover:text-gray-300 cursor-pointer">
                    -- Task Management
                  </div>
                </Link>
                ...
                <Link to="/recruitment-training" className="py-2 hover:text-gray-300">
                <div className="py-2 hover:text-gray-300 cursor-pointer">
          ...
          <div>
            ...
            {openSections.Setting && !isSidebarCollapsed && (
              <div className="ml-6">
                ...
                <Link to="/add-bank" className="py-2 hover:text-gray-300">
                  <div className="py-2 hover:text-gray-300 cursor-pointer">
                    -- Add Bank
                  </div>
                </Link>
