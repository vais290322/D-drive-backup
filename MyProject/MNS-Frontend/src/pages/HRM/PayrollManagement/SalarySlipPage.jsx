  ...
  const generatePDF = async (employee) => {
    ...
    doc.autoTable({
      ...
      body: [
        [
          "Basic Salary",
          (employee?.basicSalary || 0).toFixed(2),
          (employee?.payBasic || 0).toFixed(2),
          "PF",
          (employee?.pf || 0).toFixed(2),
        ],
        [
          "HRA",
          (employee?.baseHRA || 0).toFixed(2),
          (employee?.payHRA || 0).toFixed(2),
          "ESI",
          (employee?.esi || 0).toFixed(2),
        ],
        [
          "Conveyance Allowance",
          (employee?.conveyanceAllowance || 0).toFixed(2),
          (employee?.payConveyance || 0).toFixed(2),
          "P.tax",
          (employee?.ptax || 0).toFixed(2),
        ],
        [
          "Special Allowance",
          (employee?.specialAllowance || 0).toFixed(2),
          (employee?.paySpecialAllowance || 0).toFixed(2),
          "",
          "",
        ],
        [
          "Total Earnings",
          (employee?.basicSalaryPerMonth || 0).toFixed(2),
          (employee?.totalPayableGross || 0).toFixed(2),
          "Total Deductions",
          (employee?.deduction || 0).toFixed(2),
        ],
      ],
      theme: "grid",
      styles: { fontSize: 10 },
      ...
      didDrawCell: (data) => {
        ...
        if (data.row.index === 4) {
          // row 4 should be "Total Earnings"
    ...
    // Net Pay Section
    const totalEarnings = (employee?.totalPayableGross || 0).toFixed(2);
    const totalDeductions = (employee?.deduction || 0).toFixed(2);
    ...
    // Signature & Footer
    doc.setFontSize(12);
    doc.text("Authorized Signatory", 140, tableFinalY + 35);
    doc.text("Pvt Ltd", 160, tableFinalY + 48);
    doc.addImage(mnsBase64, "jpg", 130, tableFinalY + 40, 30, 10);
                          ...
                          <tr key={employee.id} className="hover:bg-blue-50 transition-colors duration-150">
                            ...
                            <td className="px-4 py-3">
                              <div className="flex items-center">
                                ...
                                ₹ {employee.totalPay?.toLocaleString('en-IN', { maximumFractionDigits: 2 }) || "0.00"}
                                </span>
                              </div>
                            </td>
                            <td className="px-4 py-3">
