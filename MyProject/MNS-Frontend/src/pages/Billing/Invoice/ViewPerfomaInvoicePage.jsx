...
const ViewPerfomaInvoicePage = () => {
      ...
      if (window.confirm("Are you sure you want to delete this invoice?")) {
        try {
          const response = await fetch(
            `${deleteInvoice}/api/v1/perfoma/delete/${invoice._id}`,
            {
              method: "DELETE",
              headers: {
                "Content-Type": "application/json",
    ...
    const handleSaveEdit = async () => {
      try {
        ...
        const response = await fetch(
          `${updateInvoice}/api/v1/perfoma/update/${selectedInvoice._id}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Proforma Invoice Management</h2>
                  ...
                  <table className="w-full mb-4">
                    <thead>
                      <tr className="bg-gray-100">
                        ...
                        <th className="p-2 text-right text-gray-600">Discount Amount</th>
                        <th className="p-2 text-right text-gray-600">Tax Rate (%)</th>
...
export default ViewPerfomaInvoicePage;
