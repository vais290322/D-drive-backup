...
const InvoiceForm = () => {
  ...
  const handleFormDataChange = (e) => {
    ...
    if (
      ...
      ["noOfPersons", "noOfDuties", "ratePerMonth", "monthDays"].includes(name)
    ) {
      const serviceAmount = calculateServiceAmount();

      // Update the first item in items array with service amount
      const newItems = [...items];
      if (newItems[0]) {
        newItems[0] = {
          ...newItems[0],
          amount: serviceAmount.toFixed(2),
          grossAmount: serviceAmount.toFixed(2),
          netAmount: serviceAmount.toFixed(2),
        };
        setItems(newItems);
        calculateTotals(newItems);
      }
      ...
      <div className="bg-white px-5 py-5 shadow-lg rounded-xl">
        ...
        <div className="flex justify-between items-center mb-4 text-sm">
          <div className="flex gap-4">
            ...
            <div className="flex gap-4 items-center text-lg mt-5 ">
              <label className="flex items-center ">
                <input
                  type="radio"
                  name="invoiceType"
                  value="product"
                  checked={formData.invoiceType === "product"}
                  onChange={handleFormDataChange}
                  className="mr-2"
                />
                Product Invoice
              ...
              <label className="flex items-center">
                <input
                  ...
                  name="invoiceType"
                  value="proforma"
                  checked={formData.invoiceType === "proforma"}
                  onChange={handleFormDataChange}
                  className="mr-2"
                />
                Proforma Bill
        ...
        <div className="flex gap-4 mb-4 text-sm">
          ...
          (<div>
            ...
            <input type="text" name="monthYear" value={formData?.monthYear} onChange={handleFormDataChange} className="border w-full p-1 ">
            </input>
          </div> ):null}
          ...
          <div>
            ...
            <input type="text" name="location" value={formData?.location} onChange={handleFormDataChange} className="border w-full p-1 "/>
