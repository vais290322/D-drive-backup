                      ...
                      <TableCell>{loan.customer?.full_name || "-"}</TableCell>
                       <TableCell className="hidden md:table-cell">
                        <Avatar
                          ...
                          onClick={() => setViewPhotoUrl(loan?.customer?.photo_url || loan?.customer?.kyc_photo_url || null)}
                        >
                          <AvatarImage src={loan.customer?.photo_url || loan.customer?.kyc_photo_url || undefined} alt={loan.customer?.full_name || ""} />
                          <AvatarFallback>
