                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.aadhaar_front_url && (
                      <Button variant="outline" size="sm" onClick={() => handleDownload(customer.aadhaar_front_url, 'aadhaar_front.png')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.aadhaar_front_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => handleDownload(customer.aadhaar_front_url, 'aadhaar_front.png')}>
                      <img
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.aadhaar_back_url && (
                      <Button variant="outline" size="sm" onClick={() => handleDownload(customer.aadhaar_back_url, 'aadhaar_back.png')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.aadhaar_back_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => handleDownload(customer.aadhaar_back_url, 'aadhaar_back.png')}>
                      <img
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.pan_card_url && (
                      <Button variant="outline" size="sm" onClick={() => handleDownload(customer.pan_card_url, 'pan_card.png')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.pan_card_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => handleDownload(customer.pan_card_url, 'pan_card.png')}>
                      <img
