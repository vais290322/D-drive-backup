...
export function NOC({ loan, customer, product, completionDate, settings }: NOCProps) {
    ...
    <div className="bg-white text-black" style={{
          ...
          <table style={{ width: "100%", fontSize: "12px", borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                ...
                <td style={{ padding: "8px 0", color: "#1e293b" }}>{customer?.full_name || 'N/A'}</td>
              </tr>
              <tr>
                <td style={{ padding: "8px 0", fontWeight: "600", color: "#475569" }}>Customer ID:</td>
                <td style={{ padding: "8px 0", color: "#1e293b" }}>{customer?.customer_code || 'N/A'}</td>
              </tr>
              <tr>
                <td style={{ padding: "8px 0", fontWeight: "600", color: "#475569" }}>Mobile:</td>
                <td style={{ padding: "8px 0", color: "#1e293b" }}>{customer?.mobile_primary || 'N/A'}</td>
              </tr>
              {customer?.email && (
                <tr>
      ...
      <div style={{ marginTop: "60px" }}>
        <div style={{ textAlign: "right" }}>
          <p style={{ fontSize: "12px", fontWeight: "600", marginBottom: "60px" }}>FOR {settings?.company_name || 'Mit Electro World'}</p>
          <div style={{ borderTop: "2px solid #1e293b", width: "250px", marginLeft: "auto", paddingTop: "10px" }}>
            ...
            <p style={{ fontSize: "11px", margin: "5px 0", color: "#64748b" }}>Place: {settings?.city || '_______________'}</p>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "10px", color: "#94a3b8", margin: 0 }}>
          Designed & Developed by {settings?.company_name || 'Vais Engineering Pvt Ltd'}
        </p>
      </div>
    </div>
  );
