        ...
        <TabsContent value="kyc" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.aadhaar_front_url && (
                      <Button variant="outline" size="sm" onClick={() => window.open(customer.aadhaar_front_url, '_blank')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.aadhaar_front_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.aadhaar_front_url, '_blank')}>
                      <img src={customer.aadhaar_front_url} alt="Aadhaar Front" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                    </div>
                  ) : (
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.aadhaar_back_url && (
                      <Button variant="outline" size="sm" onClick={() => window.open(customer.aadhaar_back_url, '_blank')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.aadhaar_back_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.aadhaar_back_url, '_blank')}>
                      <img src={customer.aadhaar_back_url} alt="Aadhaar Back" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                    </div>
                  ) : (
                    <div className="aspect-video flex items-center justify-center bg-muted/50 rounded-md border border-dashed text-muted-foreground text-xs">
                      No document
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.pan_url && (
                      <Button variant="outline" size="sm" onClick={() => window.open(customer.pan_url, '_blank')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.pan_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.pan_url, '_blank')}>
                      <img src={customer.pan_url} alt="PAN Card" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                    </div>
                  ) : (
                    <div className="aspect-video flex items-center justify-center bg-muted/50 rounded-md border border-dashed text-muted-foreground text-xs">
                      No document
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.voter_id_url && (
                      <Button variant="outline" size="sm" onClick={() => window.open(customer.voter_id_url, '_blank')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.voter_id_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.voter_id_url, '_blank')}>
                      <img src={customer.voter_id_url} alt="Voter ID" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                    </div>
                  ) : (
                    <div className="aspect-video flex items-center justify-center bg-muted/50 rounded-md border border-dashed text-muted-foreground text-xs">
                      No document
                ...
                <div className="border rounded-lg p-3 space-y-3">
                  <div className="flex justify-between items-start">
                    ...
                    {customer.driving_license_url && (
                      <Button variant="outline" size="sm" onClick={() => window.open(customer.driving_license_url, '_blank')}>
                        <Download className="h-4 w-4" />
                      </Button>
                    )}
                  </div>
                  {customer.driving_license_url ? (
                    <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.driving_license_url, '_blank')}>
                      <img src={customer.driving_license_url} alt="Driving License" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                    </div>
                  ) : (
                    <div className="aspect-video flex items-center justify-center bg-muted/50 rounded-md border border-dashed text-muted-foreground text-xs">
                      No document
                  ...
                  <div className="border rounded-lg p-3 space-y-3">
                    <div className="flex justify-between items-start">
                      ...
                      {customer.other_doc_url && (
                        <Button variant="outline" size="sm" onClick={() => window.open(customer.other_doc_url, '_blank')}>
                          <Download className="h-4 w-4" />
                        </Button>
                      )}
                    </div>
                    {customer.other_doc_url ? (
                      <div className="aspect-video relative rounded-md overflow-hidden bg-muted border group cursor-pointer" onClick={() => window.open(customer.other_doc_url, '_blank')}>
                        <img src={customer.other_doc_url} alt="Other Document" className="object-cover w-full h-full hover:scale-105 transition-transform duration-300" />
                      </div>
                    ) : (
                      <div className="aspect-video flex items-center justify-center bg-muted/50 rounded-md border border-dashed text-muted-foreground text-xs">
                        No document
              ...
              {/* Status Section */}
              <div className="mt-8 pt-6 border-t grid gap-6 md:grid-cols-2">
                <div>
