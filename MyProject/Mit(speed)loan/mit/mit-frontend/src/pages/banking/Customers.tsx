  ...
  return (
    <div className="p-6 xl:p-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="mb-6 flex flex-col md:flex-row gap-4 items-end md:items-center justify-between border-b pb-4">
      ...
      {selectedCustomerForDate && (
        <NextPaymentDateDialog
          ...
          onSave={async (date) => {
            // date is already an ISO string from the dialog, but let's ensure it's consistent
            await updateBankCustomer(selectedCustomerForDate.id, { next_payment_date: date });
