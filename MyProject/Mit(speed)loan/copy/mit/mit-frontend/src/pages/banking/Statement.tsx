...
import type { BankAccountWithCustomer, BankTransaction, BankTransactionDocument, BusinessSettings } from '@/types/types';
...
export default function Statement() {
  ...
  const [searchTerm, setSearchTerm] = useState(accountNumber);


  // console.log("value of params : ",searchTerm)
            ...
            <>
              ...
              <div className="hidden print:block print-statement-header">
                <div className="header-content">
                  <h1>{settings?.company_name || 'Mit Electro World'}</h1>
                  <p>{[settings?.address_line1, settings?.city, settings?.state].filter(Boolean).join(', ')}</p>
                  <p className="font-bold text-lg mt-2 uppercase border-t border-b border-gray-300 py-1 inline-block">Account Statement</p>
                </div>
                    ...
                    <div className="overflow-x-auto">
                      ...
                      <div className="hidden print:block print-summary print:mb-4">
                        <div className="summary-grid">
                          <div>
                            ...
                            <p className="value">{formatCurrency(transactions[transactions.length - 1]?.balance_before || 0)}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className={`value ${selectedAccount.balance < 0 ? 'text-destructive' : 'text-success'}`}>{formatCurrency(selectedAccount.balance)}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="hidden print:block print-footer print:mt-8 print:pt-4">
                        ...
                        <div className="footer-text">
                          ...
                          <p>For any queries, please contact Mit Electro World Banking Services.</p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className={`text-xl font-bold ${selectedTransaction.transaction_type === 'deposit'
                          ? 'text-success'
                          : 'text-destructive'
                          }`}>
                          {selectedTransaction.transaction_type === 'deposit' ? '+' : '-'}
