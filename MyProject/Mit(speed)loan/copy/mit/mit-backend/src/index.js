...
const openingBalanceRoutes = require('./routes/openaningBlance.route.js');
const creditDebitRoutes = require('./routes/creditDebit.route.js');

const autoPayPhonepayRoutes = require('./routes/autoPayPhonepay');
const phonePayWebsiteIntegrationRoutes = require('./routes/phonePayWebsiteIntegrationRoute');
const resetPasswordRoutes = require('./routes/resetPassword.route.js');
...
app.use('/api', autoPayPhonepayRoutes);
app.use('/api', phonePayWebsiteIntegrationRoutes);
