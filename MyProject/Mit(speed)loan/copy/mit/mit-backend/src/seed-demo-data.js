...
async function seedUsers() {
    ...
    const users = await Profile.insertMany([
        {
            _id: '65f1a2b3c4d5e6f7a8b9c0d1', // Fixed ID for Admin
        ...
        {
            _id: '65f1a2b3c4d5e6f7a8b9c0d2', // Fixed ID for Manager
        ...
        {
            _id: '65f1a2b3c4d5e6f7a8b9c0d3', // Fixed ID for Agent
    ...
    const customers = await Customer.insertMany([
        {
            ...
            aadhaar_front_url: 'https://placehold.co/600x400/png?text=Aadhaar+Front',
            aadhaar_back_url: 'https://placehold.co/600x400/png?text=Aadhaar+Back',
            pan_card_url: 'https://placehold.co/600x400/png?text=PAN+Card',
            kyc_status: 'verified',
