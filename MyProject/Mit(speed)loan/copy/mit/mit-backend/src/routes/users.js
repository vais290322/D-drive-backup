...
router.post('/:id/approve', authenticate, async (req, res) => {
    try {
        ...
        console.log('Approving user:', req.params.id, 'by:', approved_by);
        ...
        console.log('User approved successfully:', mappedUser.id);
        return res.json({ success: true, message: 'User approved successfully', user: mappedUser });
    } catch (err) {
...
router.post('/:id/reject', authenticate, async (req, res) => {
    try {
        ...
        console.log('User rejected successfully:', mappedUser.id);
        return res.json({ success: true, message: 'User rejected successfully', user: mappedUser });
    } catch (err) {
