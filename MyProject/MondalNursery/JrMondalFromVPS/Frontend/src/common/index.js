...
// const UserbackendDomain = "http://localhost:6080/api/v1/users"
// const ProductbackendDomain="http://localhost:6080/api/v1/products"


// const UserbackendDomain = "https://jrmondalnursery.com/api/v1/users"
// const ProductbackendDomain="https://jrmondalnursery.com/api/v1/products"

const UserbackendDomain = "https://collage.vaisacademy.com/jrmondalnursery/api/v1/users"
const ProductbackendDomain="https://collage.vaisacademy.com/jrmondalnursery/api/v1/products"
...
const SummaryApi = {
    ...
    distance:{
        url:`${UserbackendDomain}/distance`,
        method:'post'
    },
    addShippingCost:{
        url:`${UserbackendDomain}/addshippingcost`,
        method:'post'
    },
    updateShippingCost:{
        url:`${UserbackendDomain}/updateshippingcost`,
        method:'post'
    },
    fetchShippingCost:{
        url:`${UserbackendDomain}/fetchshippingcost`,
        method:'get'
    },
    ...
    deleteProduct : {
        url : `${ProductbackendDomain}/delete-product`,
        method : 'delete'
    },
    addCategory: {
        url : `${ProductbackendDomain}/product-category`,
        method : 'post'
    },

    fetchCategory : {
        url : `${ProductbackendDomain}/fetch-product-category`,
        method : 'get'
    },
    ...
    fetchallProduct :{
        url:`${ProductbackendDomain}/fetch-all-product`,
        method:'get'
    }
}
