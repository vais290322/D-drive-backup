...
import bhai from "../assest/logo/bhai.jpg";
import dada from "../assest/logo/dada.jpg";
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                />
                <h3 className="text-xl font-semibold">Zakir Hossain</h3>
              ...
              <div className="text-center">
                <img
                  ...
                  className="rounded-full mx-auto mb-4 h-40 w-40 "
                />
                <h3 className="text-xl font-semibold">Bachhu Molla</h3>
