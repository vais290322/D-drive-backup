...
//                                         <button className='border border-green-600 text-green-600 hover:bg-green-600 hover:text-white w-6 h-6 flex justify-center items-center rounded ' onClick={()=>decraseQty(product?._id,product?.quantity)}>-</button>
...
//                                     <button onClick={()=>navigate("/checkout")} className='bg-green-600 p-2 text-white w-full mt-2'>Buy Now</button>
//                                     )
//                                 }
...
//         </div>
//         <div>
//             <button className='bg-green-600 p-2 mb-2 rounded-full  text-white hover:bg-blue-950 ' onClick={() => navigate("/")}>Continue Shopping</button>
//         </div>
//     </div>
//   )
// }
