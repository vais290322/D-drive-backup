...
const GotoTop = () => {
  ...
  return (
    <div className='flex jusrify-center items-center'> 
        {isVisible && (
    <div className=" bg-green-600 font-medium w-8 h-8 rounded-full fixed bottom-5 right-5 z-50 flex justify-center items-center cursor-pointer" onClick={goToBtn}>
        <button>
