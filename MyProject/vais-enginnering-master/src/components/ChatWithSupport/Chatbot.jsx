...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-8 right-4">
      ...
      {/* Chatbox */}
      {isOpen && (
        <div className="w-72 mx-auto sm:w-96 h-[70vh] bg-white rounded-lg shadow-lg overflow-hidden flex flex-col mt-2 border  border-[#AC24F4] ">
          {/* Header */}
          <div
