...
import PurchaseReportPage from "../pages/Billing/Reports/PurchaseReportPage";
...
import ProfitReportPage from "../pages/Billing/Reports/ProfitReportPage";
...
import CreditDebitNotePage from "../pages/Billing/Bank/CreditDebitNotePage";
import SnigdhaCreditDebitNotePage from "../pages/SnigdhaBilling/Bank/SnigdhaCreditDebitNotePage";
import SnigdhaHSNReportPage from "../pages/SnigdhaBilling/Reports/SnigdhaHSNReportPage";
import HSNReportPage from "../pages/Billing/Reports/HSNReportPage";
import FeedbackFormPage from "../pages/Operation/FeedbackFormPage";
import NewProjectManagementPage from "../pages/Operation/NewProjectManagementPage";
import NewSiteSalarySlipPage from "../pages/HRM/PayrollManagement/NewSiteSalarySlipPage";
import NewSalarySlipPage from "../pages/HRM/PayrollManagement/NewSalarySlipPage";
import ServiceReportPage from "../pages/Billing/Reports/ServiceReportPage";
import SnigdhaServiceReportPage from "../pages/SnigdhaBilling/Reports/SnigdhaServiceReportPage";
import SingdhaGRNPage from "../pages/SnigdhaBilling/PurchaseOrder/SingdhaGRNPage";
import SnigdhaGrnReportPage from "../pages/SnigdhaBilling/Reports/SnigdhaGrnReportPage";
import SnigdhaCustomerBlancePage from "../pages/SNIGDHACRM/SnigdhaCustomerBlancePage";
import SnigdhaVendorBlancePage from "../pages/SNIGDHACRM/SnigdhaVendorBlancePage";
import ServiceGstReportPage from "../pages/Billing/Reports/ServiceGstReportPage";
import VendorBlancePage from "../pages/CRM/VendorBlancePage";
import CustomerBalancePage from "../pages/CRM/CustomerBalancePage";
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "mns-customer-blance",
            element: <CustomerBalancePage />,
          },
          {
            path: "mns-vendor-blance",
            element: <VendorBlancePage />,
          },
          // for snigdha crm
          {
            path: "snigdha-add-customer",
            element: <SnigdhaCustomerManagementPage />,
          },
          {
            path: "snigdha-client-list",
            element: <SnigdhaClientListPage />,
          },
          {
            path: "snigdha-add-vendor",
        ...
        // for inventory
          ...
          // for reports
            ...
            {
              path: "service-gst-report",
              element: <ServiceGstReportPage />,
            },
            {
              path: "hsn-report",
              element: <HSNReportPage />,
            },
            {
            ...
            {
              path: "purchase-report-mns",
              element: <PurchaseReportPage />,
            },
            {
              path: "profit-report-mns",
              element: <ProfitReportPage />,
            },
            {
              path: "service-report-mns",
            ...
            {
              path: "view-task-salary",
              // element: <ViewSalaryPage />,
              element: <NewSiteSalarySlipPage />,
            },
            // {
            ...
            },
            {
              ...
              element: <NewProjectManagementPage/>,
            },
            {
              path: "resource",
              element: <Resource />,
          ...
          //  for inventory 
            ...
            {
              path: "snigdha-purchase-report",
              element: <SnigdhaPurchaseReportPage />,
            },
            {
              path: "snigdha-profit-report",
              element: <SnigdhaProfitPage />,
            },
            {
              path: "snigdha-hsn-report",
              element: <SnigdhaHSNReportPage />,
            },
            {
              path: "snigdha-service-report",
              element: <SnigdhaServiceReportPage />,
            },
            {
              path: "snigdha-damage-report",
              element: <SnigdhaGrnReportPage />,
            },
            ...
            {
              path: "snigdha-add-service-receipt",
              element: <SnigdhaAddPaymentServicePage/>,
            },
            {
              path: "snigdha-update-service-receipt",
              element: <SnigdhaUpdatePaymentServicePage/>,
            },
            {
              path: "snigdha-view-service-invoice",
              element: <SnigdhaViewServiceInvoicePage/>,
            },
            {
              path: "snigdha-view-proforma-invoice",
              element: <SnigdhaViewPerfomaInvoicePage/>,
            },
            {
              path: "snigdha-damage",
              element: <SingdhaGRNPage/>,
            },
            {
              path: "snigdha-customer-blance",
              element: <SnigdhaCustomerBlancePage/>,
            },
            {
              path: "snigdha-vendor-blance",
              element: <SnigdhaVendorBlancePage/>,
            },
          ],
        },
          ],
