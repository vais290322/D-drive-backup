    ...
    try {
      ...
      Object.keys(updatedEmployee).forEach((key) => {
        if (
          ...
          // Skip image fields that contain cloudinary.com URLs
          if (
            (key === 'employeeImage' || key === 'panImage' || key === 'aatherImage' || key === 'frontPageImage') &&
            (typeof updatedEmployee[key] === 'string' && updatedEmployee[key].includes('cloudinary.com'))
          ) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="employeeCode"
                      value={updatedEmployee.employeeCode}
                      onChange={handleChange}
                      className="w-full p-3 border border-gray-300 rounded-lg"
