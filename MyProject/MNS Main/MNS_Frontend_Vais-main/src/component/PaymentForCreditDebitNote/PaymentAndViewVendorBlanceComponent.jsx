...
const PaymentAndViewVendorBlanceComponent = ({ vendorId, open, onClose }) => {
    ...
    const fetchVendorBalance = async () => {
        try {
          setLoading(true);
          setError(null);
          const response = await axios.get(`${backendDomainS}/api/v1/credit-debit-notes/snigdha-vendor-blance/${vendorId}`);
...
export default PaymentAndViewVendorBlanceComponent
