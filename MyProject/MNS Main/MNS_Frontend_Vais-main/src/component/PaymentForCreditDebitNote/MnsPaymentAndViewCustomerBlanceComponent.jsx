...
const MnsPaymentAndViewCustomerBlanceComponent = ({ customerId, open, onClose }) => {
  ...
  const fetchCustomerBalance = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await axios.get(`${backendDomainA}/api/v1/credit-debit-notes/mns-customer-blance/${customerId}`);
...
export default MnsPaymentAndViewCustomerBlanceComponent;
