      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <Link to="/" className="py-2 hover:text-gray-300">
            <div className={`px-4 py-2 cursor-pointer font-bold text-xl flex items-center ${location.pathname === '/' ? 'bg-blue-700 text-white rounded' : 'hover:bg-gray-700 text-blue-500'}`}>
          ...
          {[
            // crm section
            {
              ...
              links: [
                ...
                // { to: "/modify-client", label: "-- Modify & Delete Client" },
                {
                  to: "/client-list",
                  label: "-- Client List",
                  allowedRoles: ["crm", "admin", "billing", "mnsBilling"],
                },
                {
                  to: "/add-vendor",
                  ...
                  {
                  to: "/mns-customer-blance",
                  label: "-- Customer Blance",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
                {
                  to: "/mns-vendor-blance",
                  label: "-- Vendor Blance",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
              ].filter((link) =>
            ...
            },
            {
              ...
              links: [
                ...
                // { to: "/modify-client", label: "-- Modify & Delete Client" },
                {
                  to: "/snigdha-client-list",
                  label: "-- Client List",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
                {
                  to: "/snigdha-add-vendor",
                  label: "-- Vendor Management",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
                {
                  to: "/snigdha-customer-blance",
                  label: "-- Customer Blance",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
                {
                  to: "/snigdha-vendor-blance",
                  label: "-- Vendor Blance",
                  allowedRoles: ["snigdhaCrm", "admin", "snigdhaBilling"],
                },
              ].filter((link) =>
                userRole === "executive"
                  ? link.to === "/snigdha-add-customer"
                  : link.allowedRoles.includes(userRole)
              ),
            },
            // MNS billing section
              ...
              subSections: [
                ...
                },
                {
                  ...
                  links: [
                    ...
                    },
                    {
                      ...
                      label: "-- Update Receipt For Invoice",
                    },
                  ],
                },
                {
                ...
                },
                {
                  ...
                  links: [
                    ...
                    // { to: "/service-gst-report", label: "-- Service GST Report" },
                    { to: "/hsn-report", label: "-- HSN Report" },
                    ...
                    { to: "/service-report-mns", label: "-- Service Report" },
                    ...
                    {
                      to: "/purchase-report-mns",
                      label: "-- Purchase Report",
                    },
                    {
                      to: "/profit-report-mns",
                      label: "-- Profit Report",
                    },
                    { to: "/profit-loss", label: "-- All Transaction Report" },
                    {
                      to: "/received-po",
              ...
              subSections: [
                {
                  ...
                  links: [
                    ...
                    {
                      to: "/snigdha-view-service-invoice",
                      label: "-- View Service Invoice",
                    },
                    {
                      to: "/snigdha-view-proforma-invoice",
                      label: "-- View Proforma Invoice",
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  links: [
                    {
                      to: "/snigdha-add-service-receipt",
                      label: "-- Add Service Receipt Invoice ",
                    },
                    {
                      to: "/snigdha-update-service-receipt",
                      label: "-- Update Service Receipt Invoice  ",
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  links: [
                    ...
                    { to: "/snigdha-hsn-report", label: "-- HSN Report" },
                    ...
                    {
                      to: "/snigdha-purchase-report",
                      label: "-- Purchase Report",
                    },
                    {
                      to: "/snigdha-profit-report",
                      label: "-- Profit Report",
                    },
                    {
                      to: "/snigdha-profit-loss",
                ...
                <div key={name}>
                  <div
                    className={`px-4 py-2 hover:bg-gray-700 cursor-pointer flex items-center justify-between ${
                      name === "MNS Billing" || name === "Snigdha Billing"
                      ...
                      {links &&
                        links.map(({ to, label }) => (
                          <Link
                            ...
                            className="py-2"
                          >
                            <div className={`py-2 cursor-pointer rounded ${isActive(to) ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>
                              {label}
                            </div>
                          </Link>
                        ))}
              ...
              {openSections.HRM && !isSidebarCollapsed && (
                <div className="ml-6">
                  ...
                  <Link
                    ...
                    className="py-2"
                  >
                    <div className={`py-2 cursor-pointer rounded ${isActive('/employee-management') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>
                      -- Employee Management
                    </div>
                  </Link>
                  <Link
                    ...
                    className="py-2"
                  >
                    <div className={`py-2 cursor-pointer rounded ${isActive('/recruitment-training') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>
                      -- Candidate
                    </div>
                  </Link>
                  ...
                  <div>
                    ...
                    {openSubSections.LeaveManagement && (
                      <div className="ml-6">
                        <Link to="/apply-leave" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/apply-leave') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Apply Leave</div>
                        </Link>

                        <Link to="/approve-leave" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/approve-leave') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Approve Leave</div>
                        </Link>

                        <Link to="/leave-report" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/leave-report') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Leave Report</div>
                        </Link>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {openSubSections.Attendance && (
                      <div className="ml-6">
                        <Link to="/mark-attendance" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/mark-attendance') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Mark Attendance</div>
                        </Link>

                        {/* <Link to="/attendance-report" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/attendance-report') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Attendance Report</div>
                        </Link> */}

                        <Link to="/employee-shift-management" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/employee-shift-management') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Shift Management</div>
                        </Link>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {openSubSections.RFIDAttendance && (
                      <div className="ml-6">
                        <Link to="/rfid-register-employee" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/rfid-register-employee') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Register Employee</div>
                        </Link>
                        <Link to="/rfid-attendance-report" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/rfid-attendance-report') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Attendance Report</div>
                        </Link>
                        <Link to="/rfid-today-attendance" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/rfid-today-attendance') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Today's Attendance</div>
                        </Link>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {openSubSections.PayrollManagement && (
                      <div className="ml-6">
                        <Link to="/create-salary" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/create-salary') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Create Salary</div>
                        </Link>
                        <Link to="/salary-slip" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/salary-slip') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Salary Slip</div>
                        </Link>
                        <Link to="/view-task-salary" className="py-2">
                          <div className={`py-2 cursor-pointer rounded ${isActive('/view-task-salary') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Staff Wages</div>
                        </Link>
            ...
            <div>
              ...
              {openSections.Operation && !isSidebarCollapsed && (
                <div className="ml-6">
                  ...
                  {userRole === "executive" ? (
                    <>
                      <Link to="/add-project" className="py-2">
                        <div className={`py-2 cursor-pointer rounded ${isActive('/add-project') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Project Management</div>
                      </Link>
                      <Link to="/site-report" className="py-2">
                        <div className={`py-2 cursor-pointer rounded ${isActive('/site-report') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Site Report</div>
                      </Link>
                    </>
                  ) : (
                    <>
                      {/* Original operation links */}
                      <Link to="/resource" className="py-2">
                        <div className={`py-2 cursor-pointer rounded ${isActive('/resource') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Resource</div>
                      </Link>
                      {/* <Link to="/task-management" className="py-2">
                        <div className={`py-2 cursor-pointer rounded ${isActive('/task-management') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Task Management</div>
                      </Link> */}
                      <Link to="/add-project" className="py-2">
                        <div className={`py-2 cursor-pointer rounded ${isActive('/add-project') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Project Management</div>
                      </Link>
          ...
          {hasAccess("Setting") && (
            <div>
              ...
              {openSections.Setting && !isSidebarCollapsed && (
                <div className="ml-6">
                  <Link to="/set-units" className="py-2">
                    <div className={`py-2 cursor-pointer rounded ${isActive('/set-units') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Add Units</div>
                  </Link>

                  <Link to="/add-groups" className="py-2">
                    <div className={`py-2 cursor-pointer rounded ${isActive('/add-groups') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Add Groups</div>
                  </Link>

                  <Link to="/all-users" className="py-2">
                    <div className={`py-2 cursor-pointer rounded ${isActive('/all-users') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- All User</div>
                  </Link>

                  <Link to="/add-dummy-slip" className="py-2">
                    <div className={`py-2 cursor-pointer rounded ${isActive('/add-dummy-slip') ? 'bg-blue-700 text-white' : 'hover:bg-gray-700 hover:text-gray-300'}`}>-- Create Dummy Slip</div>
                  </Link>
                </div>
              )}
            </div>
