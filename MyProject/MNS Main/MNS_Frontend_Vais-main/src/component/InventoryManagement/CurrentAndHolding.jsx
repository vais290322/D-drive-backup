...
const itemListUrl = import.meta.env.VITE_REACT_FETCH_ITEMS;
...
const CurrentAndHolding = () => {
  ...
  // console.log("hsdgfhgds",selectedItem);
  ...
  const fetchCurrentInventory = async () => {
    try {
      ...
      console.log("current inventory :", response?.data?.data);
  ...
  const downloadAllItemsAsExcel = async () => {
  ...
  currentInventory.forEach((item, idx) => {
    worksheet.addRow({
      ...
      uom: item.uom || '',
      group: item.group || '',
      openningStock: item.openningStock || '',
      totalPurchase: item.totalPurchase || '',
      totalSales: item.totalSales || '',
      // seller_name: item.seller_details?.seller_name || '',
      // seller_ph_no: item.seller_details?.ph_no || '',
  ...
  workbook.xlsx.writeBuffer().then((buffer) => {
    ...
    a.href = url;
    a.download = 'MNS_All_Inventory_Items.xlsx';
    a.click();
      ...
      <Card sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Button variant="h5" fontWeight="bold" startIcon={<DownloadIcon />} sx={{ color: 'white', borderColor: 'white' }} onClick={() => downloadAllItemsAsExcel()}>
              {/* <DownloadIcon /> */}
              Download All Items
            </Button>
          </Box>
        ...
        <div className="text-3xl bg-blue-200 text-gray-700 border-b-2">
          <Tab
            icon={<StoreIcon />}
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                      <Box>
                        ...
                        <Typography variant="h6" fontWeight="bold" color="success.dark">
                          {selectedItem.openningStock?.toLocaleString() || '0'}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={6}>
                      <Box>
                        ...
                        <Typography variant="h6" fontWeight="bold" color="success.dark">
                          {selectedItem.totalPurchase?.toLocaleString() || '0'}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={6}>
                      <Box>
                        ...
                        <Typography variant="h6" fontWeight="bold" color="success.dark">
                          {selectedItem.totalSales?.toLocaleString() || '0'}
                        </Typography>
                      </Box>
                    </Grid>
...
export default CurrentAndHolding;
