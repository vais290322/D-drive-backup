...
const SnigdhaCustomerBlancePage = () => {
  ...
  const fetchCustomerBalances = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${backendDomainS}/api/v1/credit-debit-notes/snigdha-customer-blance`);
      setCustomerBalances(response.data.data || []);
      setError(null);
    } catch (err) {
      setError('Failed to fetch customer balances');
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        ...
        <span className="ml-3 text-lg text-gray-700">Loading customer balances...</span>
      </div>
    );
  }
          ...
          <table className="table-auto w-full border-collapse">
            <thead>
              <tr className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700">
                ...
                <th className="border-b border-gray-200 px-4 py-3 text-left font-semibold">Customer Name</th>
                <th className="border-b border-gray-200 px-4 py-3 text-left font-semibold">Customer ID</th>
              ...
              {currentRows.length > 0 ? (
                currentRows.map((customer, index) => (
                  <tr key={customer._id} className="hover:bg-blue-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-800 font-medium">{customer.customerName || 'N/A'}</td>
                    <td className="px-4 py-3 text-gray-600">{customer.customerId || 'N/A'}</td>
                ...
                <tr>
                  <td colSpan="7" className="px-4 py-8 text-center text-gray-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-lg">No customer balances found</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <p><span className="font-medium">Customer Name:</span> {selectedCustomer.customerName || 'N/A'}</p>
                    <p><span className="font-medium">Customer ID:</span> {selectedCustomer.customerId || 'N/A'}</p>
...
export default SnigdhaCustomerBlancePage;