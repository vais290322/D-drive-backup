...
const SnigdhaProfitPage = () => {
  ...
  const generatePDF = () => {
    ...
    try {
      ...
      // Add title
      doc.setFontSize(18);
      doc.text('Profit Report for Snigdha Enterprise', 14, 22);
      ...
      doc.text(`Total Sales: ${reportSummary.totalSales.toFixed(2)}`, 70, 62);
      doc.text(`Total Cost: ${reportSummary.totalCost.toFixed(2)}`, 130, 62);
      doc.text(`Total Profit: ${reportSummary.totalProfit.toFixed(2)}`, 190, 62);
      ...
      if (viewMode === 'invoices') {
        ...
        const avgMargin = filteredInvoices.length ? (totalProfit / totalCost) * 100 : 0;
      ...
      // Save the PDF
      doc.save('profit_report_snigdha.pdf');
  ...
  const generateExcel = () => {
    ...
    try {
      ...
      // Generate Excel file
      XLSX.writeFile(wb, 'profit_report_snigdha.xlsx');
      ...
      <Paper elevation={3} className="p-4 mb-4">
        <Box className="mb-4 flex justify-between items-center flex-wrap">
          <Typography variant="h5" component="h1" className="font-bold">
            Profit Report for Snigdha Enterprise
          </Typography>
