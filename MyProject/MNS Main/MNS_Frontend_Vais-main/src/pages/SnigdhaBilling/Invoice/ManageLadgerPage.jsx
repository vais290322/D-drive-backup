    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Update product Receipt for Invoice in Snigdha
        </h2>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {currentItems?.map((invoice, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm font-medium text-gray-900">
                          {invoice?.invoiceId?.date
                            ? new Date(invoice.invoiceId.date).toLocaleDateString("en-IN")
                            : ""}

                        </td>
                        {/* <td className="px-4 py-3 text-sm text-gray-600">
                          ₹{invoice?.totalWithoutDebitNoteAmount?.toFixed(2)}
                        </td> */}
                        {/* <td className="px-4 py-3 text-sm text-gray-600">
                          ₹{invoice?.totalDebitNoteAmount?.toFixed(2)}
                        </td> */}
                        <td className="px-4 py-3 text-sm text-gray-600">
                ...
                <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                  ...
                  {isEditMode ? (
                    <div className="space-y-4">
                      ...
                      <div> <label className="block text-sm font-medium text-gray-700 mb-1 md:flex items-center"> <MdOutlinePayments fontSize="small" className="mr-1 text-gray-500" /> Payment Type </label>
                        <select
                          name="paymentMode"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="0.00"
                            readOnly={data.paymentMode === 'Voucher'}
                          />
                        </div>
