...
const SnigdhaAddPaymentServicePage = () => {
  ...
  const [paymentStatusFilter, setPaymentStatusFilter] = useState("all"); // Add payment status filter
  ...
  // for customer blance on 13-12-2025
  ...
  const getAllInvoices = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${backendDomainS}/api/v1/service-invoice`, {
        method: "GET",
        headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const updateData = {
        ...productDetails,
        totalAmount: Number((selectedInvoice.totalPayableAmount || selectedInvoice?.grandTotal).toFixed(2)) || 0,
        invoiceType: "service",
        paymentDetails: [
          {
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Add Service Receipt for Invoice in Snigdha
        </h2>
...
export default SnigdhaAddPaymentServicePage;
