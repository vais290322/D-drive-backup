...
const SnigdhaUpdatePaymentServicePage = () => {
  const [allinvoice, setAllInvoice] = useState([]);
  //   console.log("get all ladger",allinvoice);
  ...
  // console.log("banks",selectedInvoice);
    ...
    try {
      ...
      filteredInvoices.forEach((invoice) => {
        const dataRow = [
          ...
          Number(invoice.totalAmount.toFixed(2)) || 0,
          Number(invoice.totalPaidAmount.toFixed(2)) || 0,
          Number(invoice.dueAmount.toFixed(2)) || 0,
  ...
  const handleDownloadInvoice = () => {
    ...
    pdf.text(
      `Date: ${formatDateDDMMYYYY(selectedInvoice?.invoiceId?.date) || " "}`,
      leftX,
      y + 26
    );
    pdf.text(
    ...
    pdf.text(
      `Total Amount: ${selectedInvoice?.totalAmount.toFixed(2) || 0}`,
      rightX,
      y + 18
    );
    pdf.text(
    ...
    if (
      ...
      selectedInvoice.paymentDetails.forEach((payment, index) => {
        ...
        xPos = margin + 3;
        pdf.text(formatDateDDMMYYYY(payment.paymentDate) || "N/A", xPos, y + 5.5);
    ...
    if (
      ...
      selectedInvoice?.invoiceId?.items.forEach((item, index) => {
        ...
        xPos = margin + 3;
        pdf.text(item?.description || "N/A", xPos, y + 5.5);
        xPos += itemWidths[0];
  ...
  const getAllInvoices = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${backendDomainS}/api/v1/service-ledger`, {
        method: "GET",
        headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${backendDomainS}/api/v1/service-ledger/${selectedInvoice._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Update service receipt in Snigdha
        </h2>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            ...
            >
              ...
              >
                ...
                <MenuItem value="customerName">Description</MenuItem>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {currentItems?.map((invoice, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm font-medium text-gray-900">
                          {invoice?.invoiceId?.items?.[0]?.description}
                        </td>
                        <td className="px-4 py-3 text-sm font-medium text-gray-900">
                          {formatDateDDMMYYYY(invoice?.invoiceId?.date)}
                        </td>
                        ...
                        <td className="px-4 py-3 text-sm text-center">
                          <div className="flex justify-end gap-2">
                            ...
                            {/* Customer Balance Button - Added here */}
                            <IconButton
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span className="text-gray-800">
                          {formatDateDDMMYYYY(selectedInvoice?.invoiceId?.date)}
                        </span>
                      </p>
                      <p className="flex justify-between items-center py-2 border-b border-gray-100">
                        <span className="font-medium text-gray-600 flex items-center">
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200 mb-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full mb-4">
                    <thead>
                      <tr className="bg-indigo-50 text-indigo-800">
                        <th className="p-2 text-left rounded-l-md">Description</th>
...
export default SnigdhaUpdatePaymentServicePage;
