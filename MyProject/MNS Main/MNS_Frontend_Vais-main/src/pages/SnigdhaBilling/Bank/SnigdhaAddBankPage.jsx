...
const SnigdhaAddBankPage = () => {
  ...
  const handleSubmit = async () => {
    try {
      if (isEdit) {
        await axios.put(`${backendDomainS}/api/v1/bank/update/${currentId}`, formData);
        showAlert('Bank account updated successfully', 'success');
      } else {
        await axios.post(`${backendDomainS}/api/v1/bank/create`, formData);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this bank account?')) {
      try {
        await axios.delete(`${backendDomainS}/api/v1/bank/delete/${id}`);
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="text-sm font-medium text-gray-900">
                            <Link to={`/billing/bank/snigdha/${bank._id}`} className="hover:text-blue-600 transition-colors">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">Only positive values are allowed</p>
                </div>
              </div>
            </div>
...
export default SnigdhaAddBankPage;
