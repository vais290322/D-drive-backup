...
import ItemsReportComponent from "../../../component/Reports/ItemsReportComponent";
  ...
  const handleExcelExport = () => {
    ...
    const exportData = filteredData.map((item) => {
      ...
      return {
        ...
        "Opening Stock": item?.openningStock || 0,
    ...
    XLSX.writeFile(
      workbook,
      `Inventory_Report_mns_${new Date().toISOString().split("T")[0]}.xlsx`
    );
  };
  // Handle PDF export
  const handlePdfExport = () => {
    ...
    filteredData.forEach((item) => {
      ...
      const rowData = [
        ...
        item?.uom || "N/A",
        item?.group || "N/A",
        item?.openningStock || 0,
        item?.totalPurchase || 0,
        item?.totalSales || 0,
        item?.quantity || 0,
        item?.unit_prize.toFixed(2).replace("", "Rs."),
        totalValue.toFixed(2).replace("", "Rs."),
        status,
      ];
    ...
    doc.save(`Inventory_Report_mns_${new Date().toISOString().split("T")[0]}.pdf`);
  };
