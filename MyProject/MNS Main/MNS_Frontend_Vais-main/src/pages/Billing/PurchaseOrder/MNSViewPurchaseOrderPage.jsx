...
import { MNSPurchasePdfDownloadButton } from "./MNSPurchasePdf"; 
...
export default function MNSViewPurchaseOrderPage() {
  ...
  const handlePrintInvoice = (invoice) => {
    ...
    link.innerHTML = "<MNSPurchasePdfDownloadButton invoice={invoice} />";
  ...
  const handleSelect = (index, suggestion) => {
    ...
    updatedItems[index] = {
      ...
      unitPrice: suggestion.unit_prize || 0,
      query: suggestion.item_name,
      filteredSuggestions: [],
      group: updatedItems[index].group || suggestion.group || "",
      unit: updatedItems[index].unit || suggestion.uom || "",
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Purchase Management for MNS Secure Solutions
        </h2>
                              ...
                              >
                                ...
                                <td className="p-2 text-right">
                                  <input
                                    type="number"
                                    value={
                                      selectedInvoice.items[index]?.netAmount ||
                                      0
                                    }
                                    onChange={(e) =>
                                      handleItemChange(
