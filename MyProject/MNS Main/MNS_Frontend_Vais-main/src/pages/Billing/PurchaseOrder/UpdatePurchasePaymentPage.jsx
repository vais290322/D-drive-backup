...
const UpdatePurchasePaymentPage = () => {
  ...
  const getAllPurchaseInvoices = async () => {
    try {
      ...
      const response = await fetch(
        `${backendDomainA}/api/v1/purchase-account/all`,
        {
          method: "GET",
          headers: {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      console.log("Payment and voucher payload:", payload, voucherDetails);
      // return;

      const response = await fetch(
        `${backendDomainA}/api/v1/purchase-account/update/${selectedInvoice._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
...
export default UpdatePurchasePaymentPage;
