...
const BankDetailsPage = () => {
  ...
  const fetchRecentTransactions = async () => {
    try {
      const response = await axios.get(
        `${backendDomainA}/api/v1/reports/bank-transactions/${bankId}`
      );
      console.log("response from bank transactions", response);
  ...
  const fetchBankDetails = async () => {
    ...
    try {
      const response = await axios.get(
        `${backendDomainA}/api/v1/bank/${bankId}`
      );
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden mt-6">
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <Link
                  to={`/add-deposit-mns`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"> 
                ...
                <Link
                  to={`/withdraw-mns`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <Link to={`/bank-statement-mns`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <Link to={`/money-transfer-mns`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
