        ...
        <Page size="A4" style={styles.page}>
            ...
            <View style={{ position: "relative", zIndex: 1 }}>
                ...
                <View style={styles.row}>
                   <View style={{ width: "60%" }}>
                        <Text style={styles.bold}>MNS SECURE SOLUTIONS PVT. LTD.</Text>
                        <Text style={styles.small}>AB-79, SALT LAKE CITY, SECTOR-I</Text>
                        <Text style={styles.small}>KOLKATA - 700064</Text>
                        <Text style={styles.small}>GSTIN: 19AAQCM5971R1Z6</Text>
                        <Text style={styles.small}>Phone: +91  91477 17001 / 033 4060 2144</Text>
                        <Text style={styles.small}>Email: mnssecuresolutions@gmail.com</Text>
                    </View>
                </View>
                {/* To Section */}
                <View
                  ...
                  <View style={styles.footer}>
                    <View style={styles.footerRow}>
                        <View style={styles.footerCol}>
                            ...
                            <Text style={{ ...styles.small, lineHeight: 1.2, paddingBottom: 4 }}>MNS SECURE SOLUTIONS PVT. LTD.</Text>
                        ...
                        <View style={styles.footerCol}>
                            ...
                            <Text style={{ ...styles.small, lineHeight: 1.2, paddingBottom: 4 }}>Phone: +91 91477 17001 / 033 4060 2144</Text>
                            <Text style={{ ...styles.small, lineHeight: 1.2, paddingBottom: 4 }}>
                                Email: mnssecuresolutions@gmail.com
                            </Text>
                            <Text style={{ ...styles.small, lineHeight: 1.2, paddingBottom: 4 }}>
                                GSTIN: 19AAQCM5971R1Z6
                            </Text>
                        </View>
                        <View style={styles.footerCol}>
...
const CreditDebitNotePdf = ({ pdfData }) => {
    ...
    useEffect(()=>{
        const fetchBankDetails = async () => {
            try {
                const response = await axios.get(`${backendDomainA}/api/v1/credit-debit-notes/all`);
