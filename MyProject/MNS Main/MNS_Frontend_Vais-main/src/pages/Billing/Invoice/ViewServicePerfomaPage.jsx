...
const fetchInvoice = import.meta.env
  .VITE_REACT_FETCH_SERVICE_PERFOMA_INVOICE_MNS;
const updateInvoice = import.meta.env
  .VITE_REACT_UPDATE_SERVICE_PERFOMA_INVOICE_MNS;
const deleteInvoice = import.meta.env
  .VITE_REACT_DELETE_SERVICE_PERFOMA_INVOICE_MNS;
...
const ViewServicePerfomaPage = () => {
  ...
  const getAllInvoices = async () => {
    try {
      ...
      // console.log("jsonData from fetchInvoice : ", jsonData);
  ...
  const handleDelete = async (invoice) => {
    if (window.confirm("Are you sure you want to delete this invoice?")) {
      try {
        const response = await fetch(`${deleteInvoice}/${invoice._id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      const updateData = {
        ...
        total: {
          ...
          grossAmount:
            ...
            "0.00",
          grandTotal:
            selectedInvoice.total?.grandTotal ||
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Service Proforma Invoice Management
        </h2>
