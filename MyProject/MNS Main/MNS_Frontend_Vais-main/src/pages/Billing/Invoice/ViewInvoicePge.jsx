...
const ViewInvoicePageS = () => {
  ...
  const handleSelect = (index, suggestion) => {
    ...
    //   unit: suggestion.unit || "", // Ensure unit is set from suggestion
    ...
    updatedItems[index] = {
      ...
      unit: updatedItems[index].unit || suggestion.unit || updatedItems[index].uom || suggestion.uom || "",
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      // console.log("Update payload:", selectedInvoice);
      // return;
                ...
                <>
                  ...
                  <div className="flex justify-end">
                    <div className="w-80 bg-gray-50 p-4 rounded-lg">
                      ...
                      <ddiv className="flex justify-between mb-2">
