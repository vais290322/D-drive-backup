...
const ViewProductPaymentInvoice = () => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const jsonData = await response.json();
      console.log("jsond data : ",jsonData)
      ...
      const receiptPayload = {
        ...
        location: jsonData.data.invoiceId.receiverDetails.address ||  jsonData.data.invoiceId.receiverDetails.address || " ",
        grandTotal: jsonData.data.totalAmount || jsonData.data.invoiceId.totalPayableAmount || jsonData.data.invoiceId.grandTotal,
      };
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm text-center">
                          <div className="flex justify-end gap-2">
                            ...
                            >
                              <EditIcon fontSize="small" className="text-blue-500 cursor-pointer hover:bg-blue-50" />
                            </IconButton>
                            <IconButton
                            ...
                            <IconButton
                              ...
                              title="View Invoice"
                            >
                              <RemoveRedEyeIcon fontSize="small" className="text-indigo-500 cursor-pointer hover:bg-indigo-50" />
                            </IconButton>
                          </div>
                        </td>
                      </tr>
                  ...
                  {isEditMode ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        {selectedInvoice && data?.paymentMode !== "Voucher" && parseFloat(data.paymentAmount || 0) >
