...
const ViewPerfomaInvoicePage = () => {
  ...
  const getAllInvoices = async () => {
    try {
      ...
      // console.log("Fetched Invoices:", jsonData);
  ...
  const handleSaveEdit = async () => {
    try {
      const updateData = {
        ...
        // totalPayableAmount: selectedInvoice.grandTotal,
        // roundOff: 0, // Update later if needed
      };
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm text-center">
                          ...
                          <IconButton
                            ...
                            >
                              <DownloadIcon fontSize="small" className="text-green-700 hover:bg-green-50" />
                            </IconButton>
                          </div>
                        </td>
                      </tr>
                        ...
                        <input
                          ...
                          value={
                            selectedInvoice?.poDate
                              ? new Date(selectedInvoice.poDate).toISOString().split("T")[0]
                              : ""
                          }
                          onChange={(e) =>
                            setSelectedInvoice({
                              ...selectedInvoice,
                              poDate: e.target.value, // backend can reconvert if needed
                            })
                          }
                          className="w-full p-2 border rounded"
                        />
