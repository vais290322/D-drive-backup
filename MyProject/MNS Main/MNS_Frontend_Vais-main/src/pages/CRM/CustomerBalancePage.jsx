...
function CustomerBalancePage() {
  ...
  const fetchCustomerBalances = async () => {
    try {
      ...
      const response = await axios.get(
        `${backendDomainA}/api/v1/credit-debit-notes/mns-customer-blance`
      );
  ...
  useEffect(() => {
    ...
    if (minCredit !== "") {
      result = result.filter(
        (customer) => customer.availableCredit >= parseFloat(minCredit) || 0
      );
    }
    if (maxCredit !== "") {
      result = result.filter(
        (customer) => customer.availableCredit <= parseFloat(maxCredit) || 0
      );
    }
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div className="mb-4 flex justify-between items-center">
          <p className="text-gray-600">
            ...
            {Math.min(indexOfLastRow, filteredBalances.length)} of{" "}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                {selectedCustomer.appliedInvoices &&
                selectedCustomer.appliedInvoices.length > 0 ? (
                  <div className="overflow-x-auto">
                    <table className="min-w-full border border-gray-200">
                      ...
                      <tbody>
                        {selectedCustomer.appliedInvoices.map(
                          (invoice, index) => (
