...
// this salary page for task and project management, and it is not related to the manual attendance component or the mark attendance page.
  ...
  const fetchEmployeeData = async () => {
    ...
    try {
      const response = await axios.get(
        `${backendDomainR1}/api/v1/salary/calculate/all?month=${month}-${year}`
      );
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8 text-white">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold mb-2">Salary Slip Management for tasks and projects </h1>
                <p className="text-blue-100">
                  Generate and manage employee task's salary slips
                </p>
              </div>
