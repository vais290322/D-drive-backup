...
export const login = async (req, res) => {
  try {
    ...
    // res.cookie("hi hello", "hi hello bye bye");

    // ✅ Set cookie and send response
    res.cookie("authToken", token, tokenOptions).status(200).json({
      success: true,
...
export const changeRole = async (req, res) => {
  try {
    ...
    // Validate role
    const validRoles = ["admin", "user", "crm", "hrm", "billing", "operation", "mnsBilling","snigdhaBilling","executive"];
