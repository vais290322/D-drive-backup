...
import snigdhaGrnRoute from './SnigdhaRoute/snigdhaGrn.route.js'; // 28-11-2025
...
app.use(cors({
    origin: ["*", "https://info.mnssecuresolutions.com", "http://localhost:5173", "http://localhost:4173", "http://localhost:5174", "http://192.168.0.112:5174", "http://192.168.0.112:5173","http://192.168.0.113:5174"],
    credentials: true
}))
...
//* my routes snigdha grn
app.use("/s/api/v1/grn", snigdhaGrnRoute);
