// const academicApi = "http://192.168.0.156:8081/api/v1/Academic";

// const academicApi = "http://147.93.116.69:8081/api/v1/Academic";
// const academicApi = "https://collage.vaisacademy.com/service5/api/v1/Academic";

const baseUrl = import.meta.env.VITE_REACT_SERVICE5_URL

const academicApi = `${baseUrl}/api/v1/Academic`;
