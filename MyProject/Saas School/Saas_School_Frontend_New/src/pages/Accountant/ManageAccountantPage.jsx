...
import { setAccountantInfo, setEdpInfo } from "@/utils/teacher/teacherInformationSlice";
...
const ManageAccountantPage = () => {
  ...
  const allAccountantInfo = useSelector((state) => state.teacherInfo.accountantInfo) || [];
  ...
  const dataLength = allAccountantInfo?.length;
  ...
  const fetchAccountantData = async () => {
    try {
      ...
      if (response) {
        dispatch(setAccountantInfo(response?.data?.data || []));
      }
    } catch (error) {
  ...
  const editAccountant = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        // Add the file
        formData.append("accImage", selectedFile);
        requestData = formData;
      }

      const response = await axios.put(
        `${teacherEdpLibraryanUrlApi.addAccountant.url}/${currentStudent.id}/${schoolId}`,
        requestData,
        {
          headers: {
  ...
  const paginatedData = allAccountantInfo?.slice(
      ...
      <div className="max-w-7xl mx-auto pt-6 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">Manage Accountant Staff</h1>
          </div>
          <p
            className={`mt-2 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
          >
            View, edit and manage all Accountant staff members
          </p>
        </div>
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold">Accountant Staff List</h2>
            <p
              className={`text-sm ${
                        ...
                        >
                          ...
                          >
                            <Dialog>
                              ...
                              <DialogContent
                                className={`p-6 rounded-xl shadow-2xl max-w-2xl ${
                                  isDarkMode
                              ...
                              >
                                <DialogHeader>
                                  <DialogTitle
                                    className={`text-2xl font-semibold border-b pb-3 flex items-center gap-2 ${
                                      isDarkMode
                          ...
                          >
                            <div className="flex justify-end items-center gap-2">
                              <Dialog>
                                ...
                                >
                                  <DialogHeader
                                    className={`sticky top-0 z-10 pb-2 border-b ${
                                      isDarkMode
                                  ...
                                  >
                                    ...
                                    >
                                      Edit Accountant Staff
                                    </DialogTitle>
                                  </DialogHeader>

                                  <form
                                    onSubmit={editAccountant}
                              ...
                              <DeleteComponent
                                name={item.accName} // Name of the item
                                deletePath={`${teacherEdpLibraryanUrlApi.addAccountant.url}/${item.id}/${schoolId}`} // API endpoint for deletion
                                onDelete={() => {
                                  const updatedData = allAccountantInfo?.filter(
                                    (data) => data.id !== item.id
                                  );
                                  dispatch(setAccountantInfo(updatedData)); // Update the Redux state after deletion
                                }}
                              />
                            </div>
                          </TableCell>
                        ...
                        >
                          <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-lg font-medium">
                              No Accountant staff found
                            </p>
                            <p className="text-sm mt-1">
                              Add new accountant staff members to see them here
                            </p>
                          </div>
                        </TableCell>
                      </TableRow>
