...
import { incomePageSteps } from "@/components/Tour/Steps/AccountsSteps/Step";
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className={`w-full border rounded p-2 mt-1 focus-visible:ring-1 ${
            isDarkMode 
              ? "bg-[#1a2747] text-white border-[#1e2a4a] focus-visible:ring-blue-500/50" 
              : "bg-white text-gray-800 border-slate-200 focus-visible:ring-green-500/50"
          }`}
        ...
        <div className={`p-4 sm:p-6 border-b ${borderColor} bg-gradient-to-r ${
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className={`p-2 rounded-full ${isDarkMode ? 'bg-green-900/30' : 'bg-green-50'}`}>
              <Search className={`h-5 w-5 ${isDarkMode ? 'text-green-400' : 'text-green-600'}`} />
            </div>
            <h2 className="text-xl sm:text-2xl font-bold">Search Income Records</h2>
          </div>
            ...
            <div className="relative w-full sm:w-auto flex-1">
              ...
              <input
                ...
                className={`pl-10 pr-4 py-2 w-full searchBox rounded-md border ${
                  ...
                  isDarkMode ? 'focus:ring-green-500/50' : 'focus:ring-green-500/50'
                }`}
              />
              {searchTerm && (
                <button 
      ...
      <div className={`mt-6 mx-4 sm:mx-8 md:mx-14 rounded-lg shadow-md overflow-hidden transition-all duration-300 ${
        ...
        <div className={`flex justify-between items-center p-4 sm:p-6 border-b ${borderColor} bg-gradient-to-r ${
          ...
          <div className="flex items-center gap-2">
            <TourButton steps={incomePageSteps} tourName="income_page" />
            <AddNewComponents 
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            ...
            <span className="ml-2 text-lg">Loading income records...</span>
          </div>
                    ...
                    <TableRow
                      ...
                      className={`transition-colors ${
                        isDarkMode 
                          ...
                          : 'hover:bg-green-50/30 border-slate-200'
                      }`}
                    >
                      {/* S.No */}
                      ...
                      <TableCell className="px-4 py-3 text-right hidden sm:table-cell">
                        <div className="flex justify-end items-center gap-2">
                          <DeleteComponent
                            ...
                            deletePath={`${accountApi}/income/${item?.id}/${schoolId}`}
                            onDelete={fetchIncomeData}
                          />
                        </div>
                      </TableCell>
                    </TableRow>
