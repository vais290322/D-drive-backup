      ...
      <div className="max-w-7xl mx-auto pt-6 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-6 p-4 rounded-lg shadow-md ${
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">Add New EDP Staff</h1>
          </div>
          <p className={`mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            Fill in the details to add a new EDP staff member to your school
          </p>
        </div>
        ...
        <div className={`mb-6 rounded-lg shadow-md overflow-hidden ${
          ...
          <div className={`p-4 border-b ${isDarkMode ? 'border-[rgba(193,193,193,0.2)]' : 'border-gray-200'}`}>
            ...
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              {currentStep === 0 
                ? "Enter personal details of the EDP staff member" 
                : "Enter address information of the EDP staff member"}
            </p>
          </div>
