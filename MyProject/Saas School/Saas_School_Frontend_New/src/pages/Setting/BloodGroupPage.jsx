...
import { bloodGroupPageSteps } from "@/components/Tour/Steps/SettingSteps/Steps";
            ...
            <div className=" flex gap-4">
              {["admin", "edp", "vais"].includes(role) && (
                              ...
                              <DialogTrigger asChild>
                                <Button className="addBloodGroup bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 text-white font-medium rounded-full px-4 py-2 transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2">
                                  <FaPlus />{" "}
                                ...
                                <DialogHeader>
                                  ...
                                  >
                                    <div className="flex items-center justify-center gap-2">
                                      <FaDroplet className={`${theme === "light" ? "text-red-400" : "text-red-500"}`} />
                                  ...
                                  <div className="grid gap-6 py-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                      ...
                                      <Input
                                        ...
                                        className={`w-full rounded-md p-2 transition-all ${
                                          theme === "light"
                                            ? "bg-gray-700 border-gray-600 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                            : "bg-white border-gray-300 text-gray-900 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                        }`}
                                    ...
                                    <div className="flex flex-col gap-2">
                                      ...
                                      >
                                        ...
                                        <SelectContent 
                                          className={theme === "light" ? "bg-gray-800 border-gray-700 text-white" : ""}
                                        >
                                          <SelectGroup>
                                            <SelectLabel className={theme === "light" ? "text-gray-400" : ""}>
                                              Blood Group Type
                                            </SelectLabel>
                                            <SelectItem 
                                              value="Positive"
                                              className={theme === "light" ? "text-white hover:bg-gray-700" : ""}
                                            >
                                              Positive (+)
                                            </SelectItem>
                                            <SelectItem 
              ...
              <TourButton
                steps={bloodGroupPageSteps}
                tourName={"bloodGroupTour"}
              />
            </div>
          </div>
                            ...
                            {item.universal ? (
                              ...
                              <div className="flex justify-end items-center gap-3">
                                ...
                                <DeleteComponent
                                  ...
                                  deletePath={`${settingUrlApi.getAllBloodGroup.url}/${item.id}/${schoolId}`} // API endpoint for deletion
                                  onDelete={() => {
