...
import { gendersPageSteps } from "@/components/Tour/Steps/SettingSteps/Steps";
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        >
          ...
          >
            ...
            {["admin", "edp", "vais"].includes(role) && (
              ...
              <DialogTrigger asChild>
                <Button className="bg-gradient-to-r from-pink-500 to-blue-500 hover:from-pink-600 hover:to-blue-600 text-white font-medium rounded-full px-4 py-2 transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2">
                  <FaPlus />{" "}
                  <span className="hidden md:inline">Add New Gender</span>
                </Button>
              </DialogTrigger>
                ...
                <DialogHeader>
                  ...
                  >
                    <div className="flex items-center justify-center gap-2">
                      <div className="flex">
                        <FaVenus className={`${theme === "light" ? "text-pink-400" : "text-pink-500"}`} />
                        <FaMars className={`-ml-1 ${theme === "light" ? "text-blue-400" : "text-blue-500"}`} />
                      </div>
                      Add A New Gender
                    </div>
                  </DialogTitle>
                  ...
                  <div className="grid gap-6 py-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        ...
                        className={`w-full rounded-md p-2 transition-all ${
                          theme === "light"
                            ? "bg-gray-700 border-gray-600 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                            : "bg-white border-gray-300 text-gray-900 focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                        }`}
            ...
            <TourButton steps={gendersPageSteps} tourName={"Genders Management"} />
            </div>
          </div>
                    ...
                    {paginatedData.map((item, index) => (
                      ...
                      >
                        ...
                        <TableCell className="px-6 py-4 flex items-center">
                          {item.genderName.toLowerCase().includes("female") ||
                          item.genderName.toLowerCase().includes("f") ? (
                            <FaVenus className="mr-2 text-pink-500" />
                          ) : item.genderName.toLowerCase().includes("male") ||
                            item.genderName.toLowerCase().includes("m") ? (
                            ...
                            {!item.universal ? (
                              <div className="flex justify-end items-center gap-3">
                                ...
                                <Dialog>
                                  ...
                                  >
                                    <DialogHeader>
                                      ...
                                      >
                                        <div className="flex items-center justify-center gap-2">
                                          <FaEdit className={`${theme === "light" ? "text-amber-400" : "text-amber-500"}`} />
                                          Edit Gender
                                        </div>
                                      </DialogTitle>
                                    </DialogHeader>
                                ...
                                <DeleteComponent
                                  ...
                                  deletePath={`${settingUrlApi.getAllGender.url}/${item.id}/${schoolId}`} // API endpoint for deletion
                                  onDelete={() => {
                              ...
                              <div className="text-right">
                                <p className="text-gray-400">System Default </p>
                              </div>
                            )}
                          </TableCell>
                        )}
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                >
                  <div className="flex">
                    <FaVenus
                      className={`text-5xl ${
                        theme === "light" ? "text-pink-400" : "text-pink-600"
                      }`}
                    />
                    <FaMars
