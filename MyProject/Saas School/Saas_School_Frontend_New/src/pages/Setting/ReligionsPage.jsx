...
import { religionPageSteps } from "@/components/Tour/Steps/SettingSteps/Steps";
            ...
            <div className=" flex gap-4">
              {["admin", "edp", "vais"].includes(role) && (
               ...
               <DialogTrigger asChild>
                 <Button className="addReligion bg-gradient-to-r from-indigo-500 to-purple-700 hover:from-indigo-600 hover:to-purple-800 text-white font-medium rounded-full px-4 py-2 transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2">
                   <FaPlus />{" "}
                   <span className="hidden md:inline">Add New Religion</span>
                 </Button>
               </DialogTrigger>
                 ...
                 <DialogHeader>
                   ...
                   >
                     <div className="flex items-center justify-center gap-2">
                       <FaBook className={`${theme === "light" ? "text-indigo-400" : "text-indigo-500"}`} />
                       Add A New Religion
                     </div>
                   </DialogTitle>
                 </DialogHeader>
                     ...
                     <div className="flex flex-col gap-2">
                       ...
                       <Input
                         ...
                         className={`w-full rounded-md p-2 transition-all ${
                           theme === "light"
                             ? "bg-gray-700 border-gray-600 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              ...
              <TourButton steps={religionPageSteps} tourName={"religionTour"} />
            </div>
          </div>
