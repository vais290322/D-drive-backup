...
const AccountantFormStepComponent = ({ step, formData, handleChange }) => {
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6`}>
            ...
            <div className="space-y-1">
              <label className={labelClasses}>
                Accountant's Name <sup className="text-red-600">*</sup>
              </label>
              <input
                required
                type="text"
            ...
            {/* for accountant image  */}
            <div className="space-y-1">
              <label className={labelClasses}>
                Accountant's Image <sup className="text-red-600">*</sup>
              </label>
  ...
  return (
    <div className={`p-4 rounded-lg ${isDarkMode ? "bg-[#1e293b]/70" : "bg-white/80"} shadow-sm`}>
      {renderStepContent()}
    </div>
  );
};

export default AccountantFormStepComponent;
