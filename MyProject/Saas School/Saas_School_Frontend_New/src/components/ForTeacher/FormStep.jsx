  ...
  const renderStepContent = () => {
    switch (step) {
      case 0:
        return (
          <div
            className={`grid grid-cols-1 mt-4 sm:grid-cols-2 gap-4 sm:gap-6`}
          >
            {/* FOR NAME  */}
            ...
            <div className="space-y-1">
              <label className={labelClasses}>
                Designation <sup className="text-red-600">*</sup>
              </label>
              <input
                required
                type="text"
      ...
      case 1:
        return (
          <div className="grid grid-cols-1 mt-4 sm:grid-cols-2 gap-4 sm:gap-6">
            {/* for joining date */}
            <div className="space-y-1">
              <label className={labelClasses}>
