                ...
                <CollapsibleTrigger asChild>
                  <NavLink to={item.url}>
                    <SidebarMenuButton
                      ...
                      className={`flex items-center cursor-pointer gap-[12px] ${isActive && "text-sky-500" // Add the "active" class for styling
                        }`}
                    >
                      {item.icon && (
                    ...
                    {item.items?.map((subItem) => {
                      ...
                      return (
                        <SidebarMenuSubItem key={subItem.title}>
                          <SidebarMenuSubButton asChild className={`flex items-center gap-[12px] ${isSubActive && "text-sky-500" // Add the "active" class for styling
                            }`}>
                            <NavLink
                              to={subItem.url}
