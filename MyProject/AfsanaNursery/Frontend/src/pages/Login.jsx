...
const Login = () => {
  ...
  return (
    <section id="login" className="bg-gradient-to-b from-green-50 to-white min-h-screen py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden relative">
            ...
            {/* Header */}
            <div className="bg-gradient-to-r from-green-800 via-yellow-600 to-green-700 text-white py-6 px-8 relative">
              ...
              <div className="flex items-center justify-center relative z-10">
                <img src={Afsana_Logo} alt="Green City Nursery" className="h-12 mr-3 bg-white p-1 rounded-md" />
            ...
            <div className="p-8 relative z-10">
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-600 to-yellow-500 hover:from-green-700 hover:to-yellow-600 text-white font-medium py-3 px-4 rounded-lg transition-colors shadow-sm hover:shadow flex items-center justify-center gap-2"
                >
                  <FaLeaf size={16} />
                  Login
                </button>
