...
const AdminProductCard = ({ data, fetchdata }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-green-100 overflow-hidden hover:shadow-md transition-shadow">
      <div className="relative">
        {/* Product Image */}
        <div className="h-48 overflow-hidden bg-gradient-to-br from-green-50 to-yellow-50">
          <img
        ...
        <div className="absolute top-2 left-2">
          <span className="bg-gradient-to-r from-green-100 to-yellow-100 text-green-800 text-xs font-medium px-2 py-1 rounded-full flex items-center">
