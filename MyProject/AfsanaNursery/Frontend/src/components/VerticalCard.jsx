      ...
      {loading ? (
        loadingList.map((product, index) => {
          return (
            <div
              key={index}
              className="w-full bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mx-auto"
            >
              <div className="bg-slate-200 h-48 p-4 flex justify-center items-center animate-pulse rounded-t-lg"></div>
        ...
        data.map((product, index) => {
          return (
            <div
              key={index}
              className="group relative w-full bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-green-100 mx-auto"
            >
              <Link
              ...
              >
                ...
                <div className="p-4 grid gap-3">
                  <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-gray-800 group-hover:text-green-700 transition-colors">
                    {product?.productName}
                  </h2>
