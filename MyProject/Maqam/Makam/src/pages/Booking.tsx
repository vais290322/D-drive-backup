  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingData = {
        ...
        // Full Data Snapshots
        flight_data: type === 'flight' ? (flight || { flightId, price }) : undefined,
        package_data: type === 'package' ? (pkg || { packageId, price }) : undefined,
      };

      const response: any = await bookingsAPI.createBooking(bookingData);
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <RadioGroup value={paymentMethod} onValueChange={(val: any) => setPaymentMethod(val)} className="flex flex-col space-y-2">
