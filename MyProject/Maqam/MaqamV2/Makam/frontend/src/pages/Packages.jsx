            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFilters({ ...filters, package_type: value })}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFilters({ ...filters, service_level: value })}
                >
                  <SelectTrigger className="h-12 text-base">
              ...
              <Card key={pkg.id} className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  ...
                  <Button asChild className="w-full">
                    <Link to={`/packages/${pkg.id || (pkg)._id}`}>View Details</Link>
                  </Button>
                </CardContent>
              </Card>
            ))
