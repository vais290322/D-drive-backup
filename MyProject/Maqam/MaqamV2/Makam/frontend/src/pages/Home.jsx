...
import { Plane, Hotel as HotelIcon, Package, Star, MapPin, Clock, Users, CheckCircle, Sparkles, ArrowRight, Zap, Shield, Phone, Headphones } from 'lucide-react';
  ...
  const loadFeaturedHotels = async () => {
    try {
      ...
      const featured = hotels
        .filter((h) => h.is_active && h.star_rating >= 4)
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Shield, title: "100% Verified", desc: "All services thoroughly verified", color: "primary" },
              { icon: Headphones, title: "24/7 Support", desc: "Expert assistance anytime", color: "primary" },
              { icon: Star, title: "Premium Quality", desc: "Uncompromising standards", color: "secondary" },
              { icon: Zap, title: "Best Value", desc: "Transparent competitive pricing", color: "secondary" }
            ].map((feature, idx) => (
              <div
                key={idx}
