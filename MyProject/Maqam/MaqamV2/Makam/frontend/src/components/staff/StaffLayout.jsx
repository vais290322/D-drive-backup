...
const StaffLayout = () => {
  ...
  const menuItems = [
    ...
    { icon, label: 'Tasks', path: '/staff/tasks' },
    { icon, label: 'Customers', path: '/staff/customers' },
    { icon, label: 'Support', path: '/staff/support' },
    { icon, label: 'Reports', path: '/staff/reports' },
    { icon, label: 'Settings', path: '/staff/settings' },
  ];
