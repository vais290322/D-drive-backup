  ...
  const faqs = [
    {
      ...
      answer:
        "Download the installer from our website and follow the step-by-step installation wizard. The process typically takes less than 5 minutes.",
    },
    {
      question: "Is my data safe with Vais SecureGuard?",
      answer:
        "Yes, we use military-grade encryption and follow strict privacy policies. We never collect or share your personal data without consent.",
    },
    {
      question: "How often should I run a scan?",
      answer:
        "While real-time protection is always active, we recommend running a full system scan at least once a week for optimal security.",
    },
    {
      question: "Can I use Vais SecureGuard on multiple devices?",
      answer:
        "Yes, depending on your subscription plan. The Pro plan supports up to 5 devices, while Enterprise allows unlimited devices.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((category) => (
              <div
                key={category.title}
                className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-8 hover:bg-white/10 transition-all duration-200 cursor-pointer"
              >
                <category.icon
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((video) => (
              <div
                key={video}
                className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 overflow-hidden group cursor-pointer"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    Learn the basics of setting up and using Vais SecureGuard
                  </p>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-8 hover:bg-white/10 transition-all duration-200 cursor-pointer">
              ...
              <p className="text-gray-400">info@vais.co.in</p>
            ...
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-8 hover:bg-white/10 transition-all duration-200 cursor-pointer">
              ...
              <p className="text-gray-400">+91 8343939495</p>
