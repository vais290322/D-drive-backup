              ...
              <div className="backdrop-blur-xl bg-white/5 rounded-3xl border border-white/10 p-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <button
                    onClick={startScan}
                    disabled={isScanning}
                    className="bg-gradient-to-r cursor-pointer from-red-600 to-orange-600 text-white px-6 py-3 rounded-full hover:from-red-700 hover:to-orange-700 transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {getCurrentFeatures().map((feature, index) => (
              <div
                key={feature.id}
                className={`backdrop-blur-xl bg-gradient-to-br ${getColorClasses(
                  feature.color
                )} rounded-2xl border p-8 hover:scale-105 transform transition-all duration-500`}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="backdrop-blur-xl bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-3xl border border-white/20 p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
              ...
              <button
                onClick={() => navigate("/pricing")}
                className="text-white border-2 border-white/20 px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/10 transition-all duration-300 flex items-center space-x-2 cursor-pointer "
              >
