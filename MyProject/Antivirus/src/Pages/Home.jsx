  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Best mobile antivirus I've used. Caught malware that others missed!",
      avatar: "AV",
    },
    {
      name: "Shivaji Singh",
      ...
      <nav className="relative z-50 px-6 py-4 ">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button className="hidden md:flex bg-gradient-to-r from-red-600 to-orange-600 text-white px-6 py-2 rounded-full hover:from-red-700 hover:to-orange-700 transform hover:scale-105 transition-all duration-200 items-center space-x-2">
        ...
        <div
          className={`md:hidden fixed inset-x-0 top-[73px] bg-gradient-to-b from-slate-900 to-slate-800 border-t border-white/10 transition-all duration-300 ${
            isMobileMenuOpen
        ...
        >
          <div className="px-6 py-4 space-y-4">
            ...
            <button className="w-full bg-gradient-to-r from-red-600 to-orange-600 text-white px-6 py-3 rounded-full hover:from-red-700 hover:to-orange-700 transition-all duration-200 flex items-center justify-center space-x-2">
              <Download className="w-4 h-4" />
              <span>Download Free</span>
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-2xl">
                  Advanced AI-powered antivirus protection that keeps your
                  mobile device safe from malware, phishing attacks, and privacy
                  breaches. Experience military-grade security in your pocket.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 left-0 right-0 flex justify-center items-center space-x-14 text-2xl text-gray-400">
                <FaRegSquare />
                <FaRegCircle />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Every feature designed to keep your mobile device secure, private,
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="backdrop-blur-xl bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-3xl border border-white/20 p-12">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join 50 million users who trust SecureGuard to protect their
              mobile devices. Start your free protection now.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Protecting millions of mobile devices worldwide with advanced
                AI-powered security solutions. Your digital safety is our
                mission.
              </p>
              <div className="flex space-x-4">
                <button className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-red-500/20 transition-all cursor-pointer ">
                  <a href="https://vais.co.in/" target="_blank">
                    {" "}
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 Vais Technologies. All rights reserved. | Protecting
              devices since 2022
            </div>
