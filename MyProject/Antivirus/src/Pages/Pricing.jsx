        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center space-x-4 mb-12">
            ...
            <button
              ...
              className="relative w-16 h-8 rounded-full bg-gradient-to-r from-red-600 to-orange-600 p-1 transition-all duration-200 cursor-pointer "
            >
              <div
                ...
                <div className="text-center mb-8">
                  ...
                  <button
                    className={`w-full bg-gradient-to-r ${getColorClasses(
                      plan.color
                    )} text-white px-6 py-3 rounded-full hover:opacity-90 transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2`}
                  >
