       ...
       <div className='bg-white rounded-lg shadow-xl w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
          ...
          <div className="bg-emerald-800 text-white p-4 relative">
            ...
            <div className='flex justify-between items-center relative z-10'>
                ...
                <button 
                  className='text-white hover:text-emerald-200 transition-colors p-1 rounded-full hover:bg-emerald-700' 
                  onClick={onClose}
                >
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <label htmlFor='uploadImageInput'>
                  <div className='border-2 border-dashed border-emerald-300 rounded-lg h-36 w-full flex justify-center items-center cursor-pointer hover:border-emerald-500 transition-colors'>
                    <div className='text-emerald-600 flex justify-center items-center flex-col gap-2'>
                      {isUploading ? (
              ...
              <div>
                ...
                <textarea 
                  className='w-full p-3 bg-gray-50 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors' 
