...
const AllProductCard = ({ heading}) => {
    ...
    // console.log("data from all product : ",data)
            ...
            return(
              <div key={product?._id} className='group relative w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100'>
                <Link to={"product/"+product?._id} className='block'>
                  <div className='bg-green-50 h-48 p-4 min-w-[280px] md:min-w-[145px] flex justify-center items-center overflow-hidden rounded-t-lg'>
                    <img 
                ...
                <div className="absolute top-2 right-2 bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity duration-300">
                  View Details
                </div>
              </div>
            )
