    ...
    return (
        <div className='relative'> 
            {isVisible && (
                <button 
                    onClick={goToBtn}
                    className="fixed bottom-8 right-6 z-50 bg-emerald-600 hover:bg-emerald-700 text-white w-10 h-10 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group overflow-hidden"
                    aria-label="Scroll to top"
                >
                    <div className="absolute inset-0 bg-emerald-500 transition-transform duration-300 transform translate-y-full group-hover:translate-y-0"></div>
