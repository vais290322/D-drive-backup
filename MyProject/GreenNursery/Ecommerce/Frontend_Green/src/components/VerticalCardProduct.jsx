      ...
      <div className='flex items-start gap-4 md:gap-6 overflow-x-auto scrollbar-none transition-all pb-4' ref={scrollElement}>
        ...
        {loading ? (
          ...
          filteredData.map((product,index)=>{
            return(
              <div key={product?._id} className='group relative w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100'>
                <Link to={"product/"+product?._id} className='block'>
                  <div className='bg-green-50 h-48 p-4 min-w-[280px] md:min-w-[145px] flex justify-center items-center overflow-hidden'>
                    <img 
