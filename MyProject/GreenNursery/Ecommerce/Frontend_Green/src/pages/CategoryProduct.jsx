...
const CategoryProduct = () => {
  ...
  return (
    <div className='container mx-auto p-4 my-8'>
      <h1 className='text-3xl font-bold text-green-800 mb-6 border-b-2 border-green-500 pb-2 inline-block'>Product Categories</h1>
      ...
      <div className='hidden lg:grid grid-cols-[250px,1fr] gap-6'>
        ...
        <div className='bg-white p-6 rounded-lg shadow-md h-fit sticky top-24'>
          ...
          <form className='text-sm flex flex-col gap-3 py-2'>
            {productCategory.map((categoryName, index) => (
              <div key={index} className='flex items-center gap-3 hover:bg-green-50 p-2 rounded-md transition-colors'>
                <input 
                  type='checkbox' 
                  name={"category"} 
        ...
        <div className=''>
          ...
          <div className='min-h-[calc(100vh-250px)]'>
            {loading ? (
              <VerticalCard loading={true} data={[]} />
            ) : filteredData.length !== 0 ? (
              <VerticalCard data={filteredData} loading={false} />
            ) : (
              <div className="text-center py-16 bg-white rounded-lg shadow-sm">
                <p className="text-gray-500 text-lg mb-2">No products found</p>
                <p className="text-gray-400">Try selecting different categories</p>
              </div>
            )}
          </div>
        </div>
      ...
      <div className='lg:hidden'>
        <button 
          ...
          className='w-full bg-green-600 hover:bg-green-700 text-white p-3 mb-4 rounded-lg shadow-sm flex items-center justify-center gap-2 transition-colors'
        >
