        ...
        <div className='bg-gray-50 min-h-screen py-8'>
            <div className='container mx-auto px-4'>
                ...
                {data.length === 0 && !loading && (
                    <div className='bg-white rounded-lg shadow-md p-8 text-center'>
                        <div className='flex justify-center mb-4'>
                            <FaSadTear className='text-gray-400 text-5xl' />
                        </div>
                        <h2 className='text-xl font-semibold text-gray-700 mb-2'>No products found</h2>
                        <p className='text-gray-500 mb-6'>We couldn't find any products matching your search.</p>
                        <div className='flex justify-center'>
                            <a href="/product-category" className='bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg transition-colors'>
                                Browse all products
                            </a>
                        </div>
                    </div>
