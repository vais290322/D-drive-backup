          ...
          <nav className="flex text-sm">
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              <li className="inline-flex items-center">
                <a href="/" className="inline-flex items-center text-gray-600 hover:text-green-600">
                  Home
                </a>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <a href="/product-category" className="text-gray-600 hover:text-green-600">
                    Products
                  </a>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="text-gray-500">
                    {loading ? "Loading..." : data?.productName?.substring(0, 30) + (data?.productName?.length > 30 ? "..." : "")}
                  </span>
                </div>
              </li>
            </ol>
        ...
        <div className='bg-white rounded-lg shadow-md p-4 md:p-8 mb-8'>
          <div className='flex flex-col lg:flex-row gap-8'>
            ...
            <div className='flex flex-col lg:flex-row-reverse gap-4 lg:w-1/2'>
              <div className='h-[300px] w-full lg:h-[400px] lg:w-[400px] bg-green-50 relative p-4 rounded-lg border border-gray-100 mx-auto'>
                {loading ? (
                ...
                {/* Product zoom */}
                {zoomImage && (
                  <div className='hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-green-50 p-1 -right-[510px] top-0 rounded-lg shadow-lg border border-gray-200 z-10'>
                    <div
                ...
                {loading ? (
                  <div className='flex gap-2 lg:flex-col overflow-auto scrollbar-none h-full'>
                    {productImageListLoading.map((el, index) => (
                      <div className='h-20 w-20 bg-slate-200 rounded-lg animate-pulse' key={"loadingImage"+index}></div>
                    ))}
                  </div>
                ) : (
                  <div className='flex gap-2 lg:flex-col overflow-auto scrollbar-none h-full'>
                    {data?.productImage?.map((imgURL) => (
                      <div 
                        className={`h-20 w-20 bg-green-50 rounded-lg p-1 border-2 transition-all duration-200 cursor-pointer ${activeImage === imgURL ? 'border-green-500' : 'border-gray-200 hover:border-green-300'}`} 
                        key={imgURL}
                      >
                        <img 
                          src={imgURL} 
            ...
            <div className='lg:w-1/2'>
              {loading ? (
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <h1 className='text-2xl lg:text-3xl font-bold text-gray-800 mb-2'>{data?.productName}</h1>
                  ...
                  <div className='flex items-center gap-1 text-amber-400 mb-2'>
                    ...
                    <FaStar/>
                    <FaStarHalf/>
                    <span className='text-gray-500 text-sm ml-2'>Top rated product</span>
                  </div>

                  <div className='flex flex-col gap-3 my-4 md:my-6'>
                    <button 
                      onClick={() => handleEnquireNow(data)}
                      className='flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium text-lg shadow-sm hover:shadow transition-all duration-300'
                    >
                      <FaWhatsapp size={20} />
                  ...
                  <div className='bg-green-50 p-4 rounded-lg mb-4'>
                    ...
                    <p className='text-sm text-gray-600'>
                      Contact us for delivery options and shipping details. We ensure safe packaging for all our plants.
                    </p>
                  </div>

                  <div>
                    <h3 className='text-gray-800 font-semibold text-lg mb-2'>Description</h3>
