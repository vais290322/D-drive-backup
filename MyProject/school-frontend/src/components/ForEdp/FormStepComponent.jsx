...
const FormStepComponent = ({ step, formData, handleChange }) => {
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4  `}>
            ...
            <div>
              <label className={`block text-sm font-medium ml-2 `}>
                Edp's Name <sup className="text-red-600">*</sup>
              </label>
              <input
                required
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium ml-2">
                Edp's Image <sup className="text-red-600">*</sup>
              </label>
              <input
                required
                type="file"
            ...
            <div className="flex flex-col items-start ">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 block w-full px-3 py-2 dark:bg-[#1f1f1f] dark:border-gray-600 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
              >
