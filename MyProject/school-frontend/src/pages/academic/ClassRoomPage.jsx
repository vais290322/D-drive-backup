...
const ClassRoomPage = () => {
  ...
  const fetchClassRoomData = async () => {
    try {
      ...
      const response = await axios.get(
       `${academicUrlApi.getAllClassRoom.url}`
      );
  ...
  const updateClassRoomData = async (e, id) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${academicUrlApi.getAllClassRoom.url}/${id}`,
        editInput,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const searchRooms = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${academicUrlApi.getAllClassRoom.url}/search?classId=${searchClass}`
      );
      if (response) {
                ...
                >
                  ...
                  >
                    <div className="flex justify-end items-center gap-2 ">
                      ...
                      <DeleteComponent
                      name={item.classId} 
                      deletePath={`${academicUrlApi.getAllClassRoom.url}/${item.id}`} 
                      onDelete={() => {
