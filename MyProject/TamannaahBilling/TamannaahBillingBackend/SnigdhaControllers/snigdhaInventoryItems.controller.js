...
import SnigdhaInventoryItem from "../SnigdhaModels/snigdhaInventoryStore.model.js"
import { deleteHoldingItem, getAllHoldingData, setHoldingItems, updateHoldingItem } from "./snigdhaHoldingItems.controller.js";
...
export const createInventoryItem = async (req, res) => {
  try {
    ...
    const newItem = new SnigdhaInventoryItem({
      item_name,
      item_id,
      unit_prize,
      sellingPrice,
...
export const getAllInventoryItems = async (req, res) => {
    try {
      ...
      const inventoryItems = await SnigdhaInventoryItem.find();
...
export const deleteInventoryItem = async (req, res) => {
    try {
      ...
      const item = await SnigdhaInventoryItem.findOne({ _id:item_id });
      ...
      await SnigdhaInventoryItem.deleteOne({ _id:item_id });
...
export const updateInventoryItem = async (req, res) => {
    try {
      ...
      const item = await SnigdhaInventoryItem.findById({ _id:item_id });
      ...
      const updatedItem = await SnigdhaInventoryItem.findOneAndUpdate({ _id:item_id }, updateData, {
