...
const SnigdhaNewProfitLossPage = () => {
  ...
  const handleExcelExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "TamannaProfitLoss");
    XLSX.writeFile(wb, "TamannaProfitLossReport.xlsx");
  };

  // Export to PDF
  const handlePdfExport = () => {
    const doc = new jsPDF({ orientation: "landscape" });
    doc.text("Tamanna's All Transactions Report", 14, 14);
    ...
    doc.save("Tamanna-all-transactions.pdf");
  };
    ...
    <div style={{ padding: 24, maxWidth: 1400, margin: "auto" }}>
      <Card style={{ marginBottom: 16, boxShadow: "0 2px 8px #f0f1f2" }}>
        <Row gutter={[16, 8]} align="middle" wrap>
          <Col>
            <Title level={4} style={{ margin: 0 }}> All Transactions Report</Title>
          </Col>
          <Col>
            <RangePicker
              value={dateRange}
