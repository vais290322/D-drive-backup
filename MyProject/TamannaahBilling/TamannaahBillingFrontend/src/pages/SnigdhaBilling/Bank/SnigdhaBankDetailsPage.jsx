          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden mt-6">
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                <Link
                  to={`/add-deposit`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"> 
                ...
                <Link
                  to={`/withdraw`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <Link to={`/bank-statement`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <Link to={`/money-transfer`} className="flex cursor-pointer flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
