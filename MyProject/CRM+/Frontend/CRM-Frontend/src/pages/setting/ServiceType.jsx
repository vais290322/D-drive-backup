      ...
      <Table>
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center text-[#312A2A] ">Service Type</TableHead>
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell className="text-center text-[#97978C] ">Website</TableCell>
          ...
          <TableRow>
            ...
            <TableCell className="text-center">Digital Marketing</TableCell>
            <TableCell className=" text-right">
          ...
          <TableRow>
            ...
            <TableCell className="text-center" >Interior Services</TableCell>
            <TableCell className=" text-right">
