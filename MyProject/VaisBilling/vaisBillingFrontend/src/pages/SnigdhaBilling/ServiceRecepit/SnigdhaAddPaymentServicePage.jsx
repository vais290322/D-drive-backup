...
const createLadgerApi = import.meta.env.VITE_BASE_URL_S;
const fetchBank = import.meta.env.VITE_BASE_URL_C;
const getAllServiveInvoice =import.meta.env.VITE_REACT_GET_SERVICE_LEDGER_SIN
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          Add Service Receipt for Invoice 
        </h2>
