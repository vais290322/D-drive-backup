...
const SnigdhaMasterLedgerReportPage = () => {
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      XLSX.writeFile(
        wb,
        `Tamanna_Master_Ledger_${activeTab}_${dayjs().format(
          "YYYY-MM-DD"
        )}.xlsx`
      );
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc.setFontSize(16);
      doc.text(
        `Tamanna Master Ledger Report - ${activeTab === "all" ? "All Transactions" : "Customer Wise"
        }`,
        14,
        15
      );
      ...
      // Save PDF file
      doc.save(
        `Tamanna_Master_Ledger_${activeTab}_${dayjs().format("YYYY-MM-DD")}.pdf`
      );
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          View and analyze all pending receivables and payables for Tamanna
        </p>
      </div>
