    ...
    >
      <div className="receipt-container">
        ...
        <div className="receipt-header">
          ...
          {paymentData?.vendor ? (
            <div className="receipt-title">Payment Voucher</div>
          ) : (
            <div className="receipt-title">Receipt Voucher</div>
          )}
        </div>
        ...
        <div className="receipt-info">
          ...
          <div className="receipt-date">
            Dated: {formatDate(paymentData.paymentDate)}
          </div>
        </div>
              ...
              {paymentData.vendor ? (
                <td>
                  ...
                  {paymentData.customerName &&
                    `Vendor: ${paymentData.customerName}`}
                </td>
              ) : (
                <td>
                  <strong>Payment Received</strong>
        ...
        <div className="footer-section">
          ...
          <div className="amount-words">
            <strong>Amount in words:</strong> INR{" "}
            {numberToWords(Math.floor(paymentAmount))}
          </div>

          <div>
            <strong>Payment received through:</strong>{" "}
            {paymentData.paymentMode || "Cash"} - Location:{" "}
            {paymentData.location || "Main Office"}
          </div>

          <div
            style={{ marginTop: "20px", fontSize: "14px", color: "#6b7280" }}
          >
            On Account of: Received payment for Invoice #
