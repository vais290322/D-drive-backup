...
import invoiceController, { restoreInvoice, softDeleteInvoice } from '../Controllers/invoice.controller.js';
...
.post('/softDelete/:id', softDeleteInvoice)
.post('/restore/:id', restoreInvoice)
