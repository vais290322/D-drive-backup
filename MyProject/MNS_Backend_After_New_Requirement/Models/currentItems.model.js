...
CurrentItemSchema.methods.reduceStock = async function (soldQuantity) {
  ...
  try {
    await this.save();
    console.log(
      `${soldQuantity} of ${this.item_name} sold. Updated stock: ${this.quantity}. Updated total price: ${this.total_prize}`
    );
  } catch (err) {
