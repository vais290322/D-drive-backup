...
const ManageEdpPage = () => {
  ...
  const fetchEdpData = async () => {
    try {
      const response = await axios.get(`${teacherEdpLibraryanUrlApi.addEdp.url}/${schoolId}`);
  ...
  const editEdp = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${teacherEdpLibraryanUrlApi.addEdp.url}/${currentStudent}/${schoolId}`, input, {
        headers: {
