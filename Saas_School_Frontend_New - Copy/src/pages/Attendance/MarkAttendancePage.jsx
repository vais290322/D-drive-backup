...
const MarkAttendancePage = () => {
  ...
  const handleSaveAttendance = async () => {
    try {
      ...
      const response = await axios.post(`${mainUrlApi.attendance.url}/${schoolId}/attendance/record?className=${searchData.className}&section=${searchData.section}&attendanceDate=${formattedDate} `, attendanceData,{
        headers: {
