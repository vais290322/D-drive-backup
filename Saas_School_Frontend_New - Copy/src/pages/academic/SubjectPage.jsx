...
// console.log("subjectData : ", subjectData);
  ...
  const addNewSubject = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${academicUrlApi.getAllSubject.url}/${schoolId}`, input, {
        headers: {
                ...
                >
                  ...
                  >
                    ...
                    />
                      ...
                      deletePath={`${academicUrlApi.getAllSubject.url}/${item.id}/${schoolId}`} // API endpoint for deletion
                      onDelete={() => {
