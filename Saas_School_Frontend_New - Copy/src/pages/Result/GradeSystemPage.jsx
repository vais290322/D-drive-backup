...
const GradeSystemPage = () => {
  ...
  const fetchGradeSystemData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${resultUrlApi.allGradeSystem.url}/${schoolId}`);
  ...
  const addNewGradeSystem = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${resultUrlApi.allGradeSystem.url}/${schoolId}`, input, {
        headers: {
  ...
  const updateGradeSystemData = async (e, id) => {
    ...
    try {
      setPostApiLoading(true);
      const response = await axios.put(`${resultUrlApi.allGradeSystem.url}/${id}/${schoolId}`, editInput, {
        headers: {
          "Content-Type": "application/json",
        },
      });
                  ...
                  >
                    <div className="flex justify-end items-center gap-2">
                      ...
                      <DeleteComponent
                        ...
                        deletePath={`${resultUrlApi.allGradeSystem.url}/${item.id}/${schoolId}`} // API endpoint for deletion
                        onDelete={() => {
