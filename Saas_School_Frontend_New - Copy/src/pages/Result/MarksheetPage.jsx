  ...
  const searchMarkSheet = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${teacherRoutine}/${schoolId}/api/v1/admit-card/search?className=${searchData.className}&section=${searchData.section}&rollNo=${searchData.rollNo}&studentName=${searchData.studentName}`
      );
