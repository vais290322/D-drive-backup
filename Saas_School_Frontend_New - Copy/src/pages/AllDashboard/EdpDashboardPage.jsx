      ...
      <div>
        ...
        <div className="flex  gap-[10px] mx-14 mt-4 ">
          <div className="flex gap-[10px] flex-col">
            ...
            <div className="flex gap-[10px] ">
              <div
                className={` w-[565px] h-[667px] border  rounded-xl ${
                  theme === "light"
                    ? "bg-[#212121] text-white border-gray-800 "
                    : "bg-white border-slate-200"
                }`}
              >
                <div className="p-5">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-20 h-20 bg-gray-300 rounded-full flex items-center justify-center text-xl font-semibold">
                      {userDetails.edpImage ? (
                        ...
                        <span>{userDetails?.edpName?.charAt(0)}</span>
                      )}
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      <p className="font-semibold">Edp's Code:</p>
                      <p>{userDetails.edpCode}</p>
                    </div>
                    <div>
              ...
              <div className="flex flex-col gap-[10px] ">
                ...
                <div className={` w-[570px] h-[667px] rounded-xl  `}>
