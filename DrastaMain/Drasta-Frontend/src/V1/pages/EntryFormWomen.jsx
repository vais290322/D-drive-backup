...
export const FocusGroupForm = () => {
  ...
  try {
    ...
    const response = await fetch(`${API}/api/v1/womenstudy`, {
      method: "POST",
      headers: {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white rounded ">
      <h2 className="text-2xl font-semibold mb-1 ">
        Entry and Retention of Women in Higher Studies and Research in Science in India
      </h2>
      <hr className="border-t-2 border-[#c0c09e] w-3xl  my-3" />
      <p className="text-sm text-center mb-6 text-gray-700">
        Your views would be screened by experts and you will be invited to participate in a Focus Group Discussion subject to your availability in e-conference mode.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block mb-1 text-sm font-medium text-gray-700">
            Comments (within 300 words) <span className="text-red-500">*</span>
          </label>
          <textarea
            name="comments"
            rows="5"
