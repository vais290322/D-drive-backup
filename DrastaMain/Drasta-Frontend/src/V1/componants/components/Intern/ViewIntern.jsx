...
const ViewIntern = ({ intern, onClose }) => {
        ...
        <div className="relative bg-gradient-to-br from-[#f8f4e5] to-[#f1e9d2] rounded-2xl max-w-md w-full mx-auto overflow-hidden shadow-xl border border-[#e8b245]/30">
          ...
          <div className="bg-[#e8b245] px-6 py-4">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold text-gray-900">Intern Profile</h3>
              <button
                onClick={onClose}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg shadow-sm border border-white">
                ...
                <p className="text-lg font-semibold text-gray-900">{intern.name}</p>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg shadow-sm border border-white">
                <h3 className="text-sm font-medium text-gray-500 mb-1">Details</h3>
                <p className="text-lg font-semibold text-gray-900">{intern.details}</p>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg shadow-sm border border-white">
                <h3 className="text-sm font-medium text-gray-500 mb-1">Year</h3>
                <p className="text-lg font-semibold text-gray-900">{intern.year}</p>
              </div>
            </div>
          </div>
