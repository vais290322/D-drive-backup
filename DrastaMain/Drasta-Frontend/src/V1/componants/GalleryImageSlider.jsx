...
const GalleryImageSlider = ({paintingPrograms}) => {
  console.log(paintingPrograms)
        ...
        <section key={index} className="max-w-7xl mx-auto px-4 py-0 pb-8">
          <div className="border bg-[#FFE9AA] p-4 sm:p-6 md:p-10 rounded shadow-sm border-black">
            <h3 className="text-base sm:text-lg font-semibold text-center mb-4">
              <span className="text-[#993366] font-bold">{program.categoryTitle}</span>{" "}
              {/* <span className="text-[#747B84]">{program.categoryDescription} </span> */}
              {/* <span className="font-medium text-[#747B84]">{program.date}</span> */}
            </h3>

            <p className="text-sm md:text-[14px] text-[#747476] mb-4 leading-relaxed align-middle">
              {program.categoryDescription}
            </p>
            ...
            <div className="relative px-2 sm:px-0 mb-6">
              <Slider {...sliderSettings}>
                {program.events.map((img, imgIndex) => (
