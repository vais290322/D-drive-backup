...
export function HomeAboutSection() {
  return (
    ...
    //   </motion.div>
    // </motion.section>
    <div className=" pt-8  mx-15 mb-10">
      {/* <div className="mx-0"> */}
        <h1 className="text-2xl font-bold mb-2 font-sans ml-0">About Us</h1>
        <p className="text-base font-sans mb-2 ml-0">
          C-DRASTĀ (to be read as 'C-DRASTA') was founded in 2015 by a group of individuals from different vocations but a common commitment to research and training for sustainable economic growth and inclusive development of society. These individuals came together to form the Board of Trustees of C-DRASTA, & entrusted the President with the responsibility of carrying C-DRASTĀ's work forward.
        </p>
        <p className="text-base font-sans mb-6 ml-0">
          'DRAŞTA', which means "observer" in Sanskrit, conveyed the Trustees' belief that the primary role of a researcher is to reason, report and disseminate based on unbiased observation.
        </p>
        <button className="border border-black px-6 py-2 rounded-lg bg-white text-black font-medium text-base cursor-pointer ml-0">
          Know More →
        </button>
      {/* </div> */}
    </div>
