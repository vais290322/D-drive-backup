...
const testimonials = [
  ...
  { name: "Ayesha Khan", feedback: "Such positive vibes and incredible teamwork. I feel proud to be part of this.", rating: 5 },
...
export const DashboardTestimonial = () => {
  ...
  return (
    <div className="md:max-w-6xl mx-auto py-10 px-4 sm:px-6 overflow-hidden">
