            ...
            <div className="bg-gray-100 h-[200px] w-full">
              ...
              <ol className="text-sm text-gray-800 space-y-4 list-decimal list-inside pl-2 pb-2 pt-3">
                <li className="font-medium">
                  ...
                  <p className="italic text-xs text-gray-600">Sreya Debnath</p>
                  <a href="https://drasta.org/wp-content/uploads/2018/07/CSR-An-Overview_SD_C-DRASTA_Posted-on-19Jul2018.pdf" target="_blank">
                  <img
                    src={pdfIcon}
                    alt="PDF Icon"
                ...
                <li className="font-medium">
                  Title: Forthcoming
                  <p className="italic text-xs text-gray-500">Author:</p>
                </li>
              </ol>
            </div>
          </div>
