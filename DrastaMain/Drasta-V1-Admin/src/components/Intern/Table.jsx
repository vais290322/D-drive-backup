...
const Table = ({ data, loading, onEdit, onDelete }) => {
  ...
  return (
    <div className="space-y-4 px-2">
        ...
        {isMobile ? (
          <div className="space-y-2">
            {currentItems.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex justify-end space-x-3 mt-3">
                    ...
                    <button
                      ...
                      onClick={() => setDeleteId({ id: item._id, year: item.year })}
                    >
                      <MdDelete size={20} />
                    </button>
                  </div>
              ...
              <div className="p-4 text-white text-center">No interns found</div>
            )}
          </div>
        ) : (
      ...
      {/* View Intern Modal */}
      <ViewIntern intern={viewIntern} onClose={() => setViewIntern(null)} />
      ...
      <ConfirmDeleteModal
        ...
        onConfirm={() => {
          if (deleteId) {
            onDelete(deleteId.id, deleteId.year);
            setDeleteId(null);
          }
        }}
      />
