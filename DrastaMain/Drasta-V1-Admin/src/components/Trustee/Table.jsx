...
import ViewTrustee from "./ViewTrustee";
...
const Table = ({ data, loading, onEdit, onDelete }) => {
  ...
  const [viewTrustee, setViewTrustee] = useState(null);
        ...
        {isMobile ? (
          <div className="space-y-2">
            {currentItems.length > 0 ? (
              ...
              <div className="p-4 text-white text-center">No trustees found</div>
            )}
          </div>
        ) : (
