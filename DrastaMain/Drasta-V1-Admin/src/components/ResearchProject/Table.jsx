...
import ViewResearchPoject from "./ViewResearchPoject";
  ...
  useEffect(() => {
    const filtered = data?.filter(
      (item) =>
        ...
        item.pdfLink?.toLowerCase().includes(searchTerm.toLowerCase())
    );
        ...
        {isMobile ? (
          <div className="space-y-2">
            {currentItems.length > 0 ? (
              ...
              <div className="p-4 text-white text-center">No projects found</div>
            )}
          </div>
        ) : (
                ...
                currentItems.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-2">
                      ...
                      >
                        {item.pdfLink?.length > 20
                          ? `${item.pdfLink.substring(0, 20)}...`
                          : item.pdfLink}
                      </a>
                    </td>
