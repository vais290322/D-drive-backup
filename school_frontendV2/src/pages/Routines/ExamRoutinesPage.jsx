...
const ExamRoutinesPage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `${routineUrlApi.getExamRoutine.url}/search?className=${searchData}&examType=${examType}`
      );
  ...
  const downloadExamRoutine = async (e) => {
    ...
    try {
      const response = await axios.get(
        `${routineUrlApi.getExamRoutine.url}/search/download?className=${searchData}&examType=${examType}`,
        {
          responseType: "blob",
        }
      );
        ...
        >
          ...
          >
            ...
            >
              ...
              {
                 ["edp", "admin", "vais",].includes(role) && (<div>
                  <AddNewExamRoutines />
                </div>)
              }
