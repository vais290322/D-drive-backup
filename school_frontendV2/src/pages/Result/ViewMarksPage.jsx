  ...
  try {
    ...
    if (role === "teacher") {
      ...
      response = await axios.get(
        `${resultUrlApi.viewMarks.url}/get/search?className=${searchData.className}&section=${searchData.section}&examType=${searchData.examType}&subject=${userDetails?.subject}`
      );
    } else if (role === "edp" || role === "admin") {
      // EDP or Admin-specific API call
      response = await axios.get(
        `${resultUrlApi.viewMarks.url}/get/search?className=${searchData.className}&section=${searchData.section}&subject=${searchData.subject}&examType=${searchData.examType}`
      );
    } else if (role === "student") {
      // Student-specific API call
      response = await axios.get(
        `${resultUrlApi.viewMarks.url}/search?className=${searchData.className}&section=${searchData.section}&examType=${searchData.examType}&roll=${userDetails?.rollNo}`
      );
    } else {
