...
const snigdhaHoldingItemSchema = new mongoose.Schema({
   ...
   quantity: { type: Number, required: true, default: 1,unique:true }, // Added quantity field
...
const SnigdhaHoldingItems = mongoose.model("SnigdhaHoldingItems", snigdhaHoldingItemSchema);

export default SnigdhaHoldingItems;
