...
const ViewPDF = ({invoiceData}) => {
  ...
  const fetchBankData = async()=>{
    ...
    // console.log("response for pdf in bank : ",response)
              ...
              <div className="flex gap-2">
                <div className="flex flex-col">
                  ...
                  <p className="text-blue-900 font-semibold text-sm">
                    Bank Name: <span className="text-[#027bd1]">{bankdetails[0]?.bankName}</span>
                  </p>
                  <p className="text-blue-900 font-semibold text-sm">
                    Acc No: <span className="text-[#027bd1]">{bankdetails[0]?.accountNumber}</span>
                  </p>
                  <p className="text-blue-900 font-semibold text-sm">
                    IFS Code: <span className="text-[#027bd1]">{bankdetails[0]?.ifscCode}</span>
                  </p>
                  <p className="text-blue-900 font-semibold text-sm">
                    Branch: <span className="text-[#027bd1]">{bankdetails[0]?.branchName}</span>
                  </p>
                </div>
                <div>
