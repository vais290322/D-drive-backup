...
const ServiceInvoicepage = ({customerDetails}) => {
  return (
...
const InvoiceForm = ({customer}) => {
  ...
  const handleItemChange = (index, field, value) => {
    ...
    if (['noOfPerson', 'noOfDuites', 'rate', 'month'].includes(field)) {
      ...
      // Calculate amount using the formula: (noOfDuites * rate) / month
      let amount = 0;
      if (monthDays > 0) {
              ...
              <tr key={index}>
                ...
                <td className="border border-gray-300 p-0">
                  <input
                    ...
                    onChange={(e) => handleItemChange(index, "noOfPerson", e.target.value)}
                  />
                </td>
                <td className="border border-gray-300 p-0">
                  <input
                    ...
                    onChange={(e) => handleItemChange(index, "noOfDuites", e.target.value)}
                  />
                </td>
                <td className="border border-gray-300 p-0">
                  <input
