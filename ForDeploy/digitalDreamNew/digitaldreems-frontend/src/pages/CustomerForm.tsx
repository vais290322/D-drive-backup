...
export default function CustomerForm() {
  ...
  const onSubmit = async (data: CustomerFormData) => {
    try {
      ...
      // Clean up data - convert empty strings to null for optional enum/date fields
      const cleanData: any = { ...data };
      const enumFields = ['marital_status', 'gender'];
      const dateFields = ['date_of_birth', 'marriage_anniversary'];

      [...enumFields, ...dateFields].forEach(field => {
        if (cleanData[field] === '') {
      ...
      if (id) {
        ...
        await api.customers.create(cleanData, data.customer_code_type === "manual" ? data.customer_code_manual : undefined);
