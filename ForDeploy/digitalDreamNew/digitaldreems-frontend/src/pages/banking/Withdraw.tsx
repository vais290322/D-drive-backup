...
import { ArrowLeft, ArrowUpFromLine, Search, Upload, X, FileText, Image as ImageIcon } from 'lucide-react';
...
export default function Withdraw() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (selectedAccount && amount > Number(selectedAccount.balance)) {
      toast({
        ...
        description: `Available balance: ${formatCurrency(selectedAccount.balance)}`,
        variant: 'destructive',
      });
      return;
    }
  ...
  const handleConfirmWithdrawal = async () => {
    try {
      console.log('DEBUG: handleConfirmWithdrawal called', { formData, selectedFiles, user });
      setLoading(true);
      const amount = parseFloat(formData.amount);
      ...
      console.log('DEBUG: processWithdrawal result', result);
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <Button type="submit" className="flex-1" disabled={loading || uploading || isInsufficientBalance()}>
        ...
        <DialogContent>
          ...
          <div className="space-y-3 py-4">
            ...
            <div className="flex justify-between text-lg">
              ...
              <span className="font-bold text-destructive">-{formatCurrency(parseFloat(formData.amount || '0'))}</span>
            </div>
            <div className="flex justify-between text-lg">
