 ...
 * Printable receipt for EMI payments - A4 Format
 */
...
export function PaymentReceipt({ payment, loan, customer }: PaymentReceiptProps) {
                ...
                {payment.collected_by && (
                  <td style={{ padding: "8px 0" }}>
                    <div>
                      ...
                      <p style={{ margin: 0, fontWeight: "600", color: "#1e293b", fontSize: "11pt" }}>{payment.collected_by}</p>
                    </div>
                  </td>
                )}
              </tr>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Designed & Developed by <strong>Vais Engineering Pvt Ltd</strong>
          </p>
          <p style={{
            margin: 0,
            fontSize: "9pt",
            ...
            For any queries, please contact: support@digitaldreams.com
          </p>
        </div>
      </div>
    </div>
