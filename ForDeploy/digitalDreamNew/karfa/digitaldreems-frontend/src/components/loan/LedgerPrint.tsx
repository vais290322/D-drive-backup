    ...
    <div className="bg-white text-black" style={{ 
            ...
            <table style={{ width: "100%", fontSize: "12px", borderCollapse: "collapse" }}>
              <tbody>
                <tr>
                  ...
                  <td style={{ padding: "5px 0", color: "#1e293b" }}>{customer.full_name}</td>
                </tr>
                <tr>
                  <td style={{ padding: "5px 0", fontWeight: "600", color: "#475569" }}>Customer ID:</td>
                  <td style={{ padding: "5px 0", color: "#1e293b" }}>{customer.customer_code}</td>
                </tr>
                <tr>
                  <td style={{ padding: "5px 0", fontWeight: "600", color: "#475569" }}>Mobile:</td>
                  <td style={{ padding: "5px 0", color: "#1e293b" }}>{customer.mobile_primary}</td>
                </tr>
                {customer.email && (
                  <tr>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div>
            ...
            <p style={{ fontWeight: "bold", color: "#2563eb", fontSize: "14px", margin: 0 }}>{formatCurrency(loan.total_payable)}</p>
          </div>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: "center", marginTop: "20px", fontSize: "10px", color: "#94a3b8" }}>
          <p style={{ margin: 0 }}>Designed & Developed by Vais Engineering Pvt Ltd</p>
        </div>
      </div>
    </div>
  );
