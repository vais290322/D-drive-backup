...
export function LoanAgreement({ loan, customer, product }: LoanAgreementProps) {
      ...
      <div style={{ marginBottom: "25px", textAlign: "justify" }}>
        ...
        <div style={{ marginBottom: "20px", paddingLeft: "20px" }}>
          ...
          <p style={{ marginLeft: "20px", marginBottom: "5px" }}>
            <strong>Digital Dreams</strong><br />
        ...
        <div style={{ marginBottom: "20px", paddingLeft: "20px" }}>
          ...
          <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
            ...
            <p style={{ marginLeft: "20px", marginBottom: "5px", flex: 1 }}>
              ...
              Mobile: {customer.mobile_primary}<br />
            ...
            <table style={{ width: "100%", fontSize: "12px", borderCollapse: "collapse" }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ padding: "8px 0", color: "#1e293b" }}>{formatCurrency(product.purchase_price)}</td>
                </tr>
              </tbody>
            </table>
          </div>
