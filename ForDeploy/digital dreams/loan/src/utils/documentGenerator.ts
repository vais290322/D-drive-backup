  ...
  const agreementHTML = `
    ...
    <body>
      <div class="header">
        ...
        <p><strong>Digital Dreems</strong></p>
      ...
      <div class="terms">
        ...
        <ol>
          ...
          <li>The product/asset mentioned above is hypothecated to Digital Dreems until full repayment of the loan.</li>
          <li>The borrower shall not sell, transfer, or dispose of the hypothecated asset without prior written consent.</li>
          <li>In case of default, Digital Dreems reserves the right to repossess the asset and take legal action.</li>
          <li>The borrower has provided accurate information and documents for KYC verification.</li>
          <li>Any change in contact details or address must be intimated to Digital Dreems immediately.</li>
      ...
      <div class="signatures">
        ...
        <div class="signature-box">
          <div class="signature-line">
            ...
            ${profile?.full_name || 'Digital Dreems'}<br>
            Date: ${new Date().toLocaleDateString()}
          </div>
        </div>
      </div>
      ...
      <div class="footer">
        ...
        <p>© ${new Date().getFullYear()} Digital Dreems. All rights reserved.</p>
      </div>
    </body>
    </html>
  `;
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>
          ...
          Loan No. <span class="highlight">${loan.loan_id}</span> taken from Digital Dreems.
        </p>
      ...
      <div class="signature">
        <p><strong>For Digital Dreems</strong></p>
        <div class="signature-line">
          <strong>Authorized Signatory</strong><br>
          ${profile?.full_name || 'Digital Dreems'}<br>
          ${profile?.role || 'Admin'}
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="value">${profile?.full_name || 'Digital Dreems'}</div>
        </div>
      </div>
      ...
      <div class="footer">
        ...
        <p>For queries, please contact Digital Dreems</p>
        <p>© ${new Date().getFullYear()} Digital Dreems. All rights reserved.</p>
      </div>
    </body>
    </html>
