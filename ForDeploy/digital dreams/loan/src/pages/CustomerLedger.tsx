  ...
  return (
    <div className="space-y-6">
      ...
      <div className="hidden print:block text-center mb-6">
        <h1 className="text-2xl font-bold">Digital Dreems</h1>
      ...
      {loans.map((loanDetail: any, index: number) => (
        <Card key={loanDetail.loan.id} className="break-inside-avoid">
          <CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted rounded-lg">
              ...
              <div>
                ...
                <p className="font-semibold">{formatCurrency(loanDetail.loan.total_interest)}</p>
              </div>
              <div>
      ...
      <div className="hidden print:block text-center text-sm text-muted-foreground mt-8 pt-4 border-t">
        ...
        <p className="mt-1">Digital Dreems - Loan Management System</p>
        <p className="mt-1">Designed & Developed by Vais Engineering Pvt Ltd</p>
      </div>
    </div>
  );
}
